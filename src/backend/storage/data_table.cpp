...
column_map_type DataTable::GetTileGroupLayout(PelotonTileGroupLayoutType layout_type) {
  ...
  std::cout << "TileGroup Layout :: " << layout_type << "\n";
...
column_map_type GetStaticColumnMap(){
  ...
  column_map[198] = std::make_pair(0, 0);
  column_map[206] = std::make_pair(0, 1);
  column_map[169] = std::make_pair(0, 2);
  column_map[119] = std::make_pair(0, 3);
  column_map[9] = std::make_pair(0, 4);
  column_map[220] = std::make_pair(0, 5);
  column_map[2] = std::make_pair(0, 6);
  column_map[230] = std::make_pair(0, 7);
  column_map[212] = std::make_pair(0, 8);
  column_map[164] = std::make_pair(0, 9);
  column_map[111] = std::make_pair(0, 10);
  column_map[136] = std::make_pair(0, 11);
  column_map[106] = std::make_pair(0, 12);
  column_map[8] = std::make_pair(0, 13);
  column_map[112] = std::make_pair(0, 14);
  column_map[4] = std::make_pair(0, 15);
  column_map[234] = std::make_pair(0, 16);
  column_map[147] = std::make_pair(0, 17);
  column_map[35] = std::make_pair(0, 18);
  column_map[114] = std::make_pair(0, 19);
  column_map[89] = std::make_pair(0, 20);
  column_map[127] = std::make_pair(0, 21);
  column_map[144] = std::make_pair(0, 22);
  column_map[71] = std::make_pair(0, 23);
  column_map[186] = std::make_pair(0, 24);
