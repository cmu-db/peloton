 ...
 */
void Value::SerializeTo(SerializeOutput &output) const {
  const ValueType type = GetValueType();
  switch (type) {
    case VALUE_TYPE_VARCHAR:
    case VALUE_TYPE_VARBINARY: {
...
void Value::SerializeToExport(ExportSerializeOutput &io) const {
  switch (GetValueType()) {
    case VALUE_TYPE_TINYINT:
    case VALUE_TYPE_SMALLINT:
    case VALUE_TYPE_INTEGER:
 ...
 */
void Value::SerializeWithAllocation(void *storage, const bool is_inlined,
 ...
 */
const Value Value::Deserialize(const void *storage, const ValueType type,
 ...
 */
int64_t Value::DeserializeFrom(SerializeInput &input,
 ...
 */
const Value Value::DeserializeWithAllocation(SerializeInput &input,
                                                    Pool *data_pool) {
