...
enum LogRecordType{
  ...
  LOGRECORD_TYPE_ARIES_TUPLE_INSERT = 8,
  LOGRECORD_TYPE_ARIES_TUPLE_DELETE = 9,
  LOGRECORD_TYPE_ARIES_TUPLE_UPDATE = 10,

  LOGRECORD_TYPE_PELOTON_TUPLE_INSERT = 11,
  LOGRECORD_TYPE_PELOTON_TUPLE_DELETE = 12,
  LOGRECORD_TYPE_PELOTON_TUPLE_UPDATE =13
};
