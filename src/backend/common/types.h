...
enum PostgresValueType {
  ...
  //  TEXTARRAYOID in postgres code
  POSTGRES_VALUE_TYPE_TEXT_ARRAY = 1009,
  // INT2ARRAYOID in postgres code
  POSTGRES_VALUE_TYPE_INT2_ARRAY = 1005,
  // INT4ARRAYOID in postgres code
  POSTGRES_VALUE_TYPE_INT4_ARRAY = 1007,
  // OIDARRAYOID in postgres code
  POSTGRES_VALUE_TYPE_OID_ARRAY = 1028,
  // FLOADT4ARRAYOID in postgres code
  POSTGRES_VALUE_TYPE_FLOADT4_ARRAY = 1021,
