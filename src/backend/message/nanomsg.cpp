 ...
 *
 */
int NanoMsg::SendMessage(int socket, const void *buffer, size_t length,
                         int flags) {
 ...
 *
 */
int NanoMsg::SetSocket(int socket, int level, int option, const void *opt_val,
                       size_t opt_val_len) {
 ...
 *
 */
int NanoMsg::ReceiveMessage(int socket, void *buffer, size_t length,
                            int flags) {
