...
class Transaction : public Printable {
 ...
 private:
  ...
  std::unordered_set<txn_id_t> inner_dep_set_; // transactions that are dependent on me.

  std::unordered_set<txn_id_t> outer_dep_set_; // transactions that i am dependent on.
