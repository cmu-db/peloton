...
//===--------------------------------------------------------------------===//
    ...
    public:
      ...
      inline ItemPointer *GetHeadPtr(const storage::TileGroupHeader *tile_group_header, const oid_t tuple_id) {
        return *(reinterpret_cast<ItemPointer**>(tile_group_header->GetReservedFieldRef(tuple_id)));
      }

      inline void SetHeadPtr(const storage::TileGroupHeader *tile_group_header, const oid_t tuple_id,
