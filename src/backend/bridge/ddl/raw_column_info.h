...
// raw_column_info.h
//
// Identification: src/backend/bridge/ddl/raw_column_info.h
//
...
class raw_column_info {
 public:
  raw_column_info(ValueType column_type, oid_t column_length,
                  std::string column_name, bool is_inlined,
