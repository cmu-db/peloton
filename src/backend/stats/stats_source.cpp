...
void StatsSource::Configure(std::string _identifier, Oid _host_id, Oid _site_id, Oid database_id) {
	host_id = _host_id;
	site_id = _site_id;
	...
	table->Reset(TableFactory::GetTempTable(database_id, identifier, schema, column_names, 0));
