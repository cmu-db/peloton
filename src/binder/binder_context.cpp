...
namespace binder {
  ...
  void BinderContext::AddTable(const parser::TableRef* table_ref, concurrency::Transaction *consistentTxn) {
  ...
  void BinderContext::AddTable(const std::string db_name,
    ...
    storage::DataTable* table =
        catalog::Catalog::GetInstance()->GetTableWithName(db_name, table_name, consistentTxn);
