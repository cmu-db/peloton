...
//
// Identification: src/codegen/data_table_proxy.cpp
//
...
const std::string& DataTableProxy::_GetSchema::GetFunctionName() {
  // TODO: FIX ME
  static const std::string kGetTileGroupCount =
#ifdef __APPLE__
      "_ZNK7peloton7storage13AbstractTable9GetSchemaEv";
#else
      "_ZNK7peloton7storage13AbstractTable9GetSchemaEv";
#endif
  return kGetTileGroupCount;
