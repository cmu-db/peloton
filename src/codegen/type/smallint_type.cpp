...
Value SmallInt::GetMinValue(CodeGen &codegen) const {
  auto *raw_val = codegen.Const16(peloton::type::PELOTON_VALUE_INT16_MIN);
  return Value{*this, raw_val, nullptr, nullptr};
}

Value SmallInt::GetMaxValue(CodeGen &codegen) const {
  auto *raw_val = codegen.Const16(peloton::type::PELOTON_VALUE_INT16_MAX);
  return Value{*this, raw_val, nullptr, nullptr};
}

Value SmallInt::GetNullValue(CodeGen &codegen) const {
  auto *raw_val = codegen.Const16(peloton::type::PELOTON_VALUE_INT16_NULL);
