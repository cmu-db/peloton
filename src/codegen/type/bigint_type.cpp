...
Value BigInt::GetMinValue(CodeGen &codegen) const {
  auto *raw_val = codegen.Const64(peloton::type::PELOTON_VALUE_INT64_MIN);
  return Value{*this, raw_val, nullptr, nullptr};
}

Value BigInt::GetMaxValue(CodeGen &codegen) const {
  auto *raw_val = codegen.Const64(peloton::type::PELOTON_VALUE_INT64_MAX);
  return Value{*this, raw_val, nullptr, nullptr};
}

Value BigInt::GetNullValue(CodeGen &codegen) const {
  auto *raw_val = codegen.Const64(peloton::type::PELOTON_VALUE_INT64_NULL);
