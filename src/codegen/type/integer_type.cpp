...
static std::vector<TypeSystem::BinaryOpInfo> kBinaryOperatorTable = {
    {TypeSystem::OperatorId::Add, true, peloton::type::TypeId::INTEGER, kAddOp},
    {TypeSystem::OperatorId::Sub, true, peloton::type::TypeId::INTEGER, kSubOp},
    {TypeSystem::OperatorId::Mul, true, peloton::type::TypeId::INTEGER, kMulOp},
    {TypeSystem::OperatorId::Div, true, peloton::type::TypeId::INTEGER, kDivOp},
    {TypeSystem::OperatorId::Mod, true, peloton::type::TypeId::INTEGER, kModuloOp}};
