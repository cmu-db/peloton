...
Value Integer::GetMinValue(CodeGen &codegen) const {
  auto *raw_val = codegen.Const32(peloton::type::PELOTON_VALUE_INT32_MIN);
  return Value{*this, raw_val, nullptr, nullptr};
}

Value Integer::GetMaxValue(CodeGen &codegen) const {
  auto *raw_val = codegen.Const32(peloton::type::PELOTON_VALUE_INT32_MAX);
  return Value{*this, raw_val, nullptr, nullptr};
}

Value Integer::GetNullValue(CodeGen &codegen) const {
  auto *raw_val = codegen.Const32(peloton::type::PELOTON_VALUE_INT32_NULL);
