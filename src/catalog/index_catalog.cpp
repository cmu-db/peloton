...
std::unique_ptr<storage::Tuple> IndexCatalog::GetIndexCatalogTuple(
  ...
  auto val1 = type::ValueFactory::GetIntegerValue(index_id);
  auto val2 = type::ValueFactory::GetVarcharValue(index_name, nullptr);
  auto val3 = type::ValueFactory::GetIntegerValue(table_id);
  auto val4 = type::ValueFactory::GetIntegerValue(database_id);
