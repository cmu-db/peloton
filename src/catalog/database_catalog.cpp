...
DatabaseCatalogObject::DatabaseCatalogObject(executor::LogicalTile *tile,
    ...
    : table_objects_cache(),
      ...
      txn(txn) {
  auto field_location = tile->GetLocationPointer(0, DatabaseCatalog::ColumnId::DATABASE_NAME);
  ...
  field_location = tile->GetLocationPointer(0, DatabaseCatalog::ColumnId::DATABASE_OID);
  PL_ASSERT(field_location != nullptr);
