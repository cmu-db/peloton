...
ColumnCatalogObject::ColumnCatalogObject(executor::LogicalTile *tile,
                                         int tupleId)
{
  auto field_location = tile->GetLocationPointer(tupleId, ColumnCatalog::ColumnId::TABLE_OID);
  PL_ASSERT(field_location != nullptr);
  table_oid = *(reinterpret_cast<const oid_t *>(field_location));

  field_location = tile->GetLocationPointer(tupleId, ColumnCatalog::ColumnId::COLUMN_NAME);
  PL_ASSERT(field_location != nullptr);
  ...
  field_location = tile->GetLocationPointer(tupleId, ColumnCatalog::ColumnId::COLUMN_ID);
  PL_ASSERT(field_location != nullptr);
  column_id = *(reinterpret_cast<const oid_t *>(field_location));

  field_location = tile->GetLocationPointer(tupleId, ColumnCatalog::ColumnId::COLUMN_OFFSET);
  PL_ASSERT(field_location != nullptr);
  column_offset = *(reinterpret_cast<const oid_t *>(field_location));

  field_location = tile->GetLocationPointer(tupleId, ColumnCatalog::ColumnId::COLUMN_TYPE);
  PL_ASSERT(field_location != nullptr);
  ...
  field_location = tile->GetLocationPointer(tupleId, ColumnCatalog::ColumnId::IS_INLINED);
  PL_ASSERT(field_location != nullptr);
  is_inlined = *(reinterpret_cast<const bool *>(field_location));


  field_location = tile->GetLocationPointer(tupleId, ColumnCatalog::ColumnId::IS_PRIMARY);
  PL_ASSERT(field_location != nullptr);
  is_primary = *(reinterpret_cast<const bool *>(field_location));


  field_location = tile->GetLocationPointer(tupleId, ColumnCatalog::ColumnId::IS_NOT_NULL);
  PL_ASSERT(field_location != nullptr);
