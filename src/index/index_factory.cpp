...
#endif
    index = new BWTreeIndex<
        GenericKey<16>, ItemPointer *, FastGenericComparator<16>,
...
#endif
    index = new BWTreeIndex<
        GenericKey<64>, ItemPointer *, FastGenericComparator<64>,
...
#endif
    index =
        new SkipListIndex<GenericKey<4>, ItemPointer *, FastGenericComparator<4>,
                        GenericEqualityChecker<4>, GenericHasher<4>,
                        ItemPointerComparator, ItemPointerHashFunc>(metadata);
  } else if (key_size <= 8) {
#ifdef LOG_TRACE_ENABLED
...
#endif
    index =
        new SkipListIndex<GenericKey<8>, ItemPointer *, FastGenericComparator<8>,
                        GenericEqualityChecker<8>, GenericHasher<8>,
                        ItemPointerComparator, ItemPointerHashFunc>(metadata);
  } else if (key_size <= 16) {
#ifdef LOG_TRACE_ENABLED
