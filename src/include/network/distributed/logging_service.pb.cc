...
void protobuf_AddDesc_logging_5fservice_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "play\022*.peloton.distributed.LogRecordRepla"
    "yRequest\032+.peloton.distributed.LogRecordR"
        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_sync_type:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::peloton::distributed::ResponseType_IsValid(value)) {
            set_sync_type(static_cast< ::peloton::distributed::ResponseType >(value));
          } else {
...
void PelotonLoggingService::LogRecordReplay(::google::protobuf::RpcController* controller,
                         const ::peloton::distributed::LogRecordReplayRequest*,
                         ::peloton::distributed::LogRecordReplayResponse*,
  ...
  switch(method->index()) {
    case 0:
      LogRecordReplay(controller,
             ::google::protobuf::down_cast<const ::peloton::distributed::LogRecordReplayRequest*>(request),
             ::google::protobuf::down_cast< ::peloton::distributed::LogRecordReplayResponse*>(response),
             done);
      break;
    default:
...
const ::google::protobuf::Message& PelotonLoggingService::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::peloton::distributed::LogRecordReplayRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::google::protobuf::Message& PelotonLoggingService::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::peloton::distributed::LogRecordReplayResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *reinterpret_cast< ::google::protobuf::Message*>(NULL);
  }
