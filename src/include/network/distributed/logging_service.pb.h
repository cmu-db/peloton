...
//
// Identification: src/include/distributed/logging_service.pb.h
//
...
class LogRecordReplayRequest : public ::google::protobuf::Message {
 ...
 public:
  ...
  // required .peloton.distributed.ResponseType sync_type = 2;
  inline bool has_sync_type() const;
  inline void clear_sync_type();
  static const int kSyncTypeFieldNumber = 2;
  inline ::peloton::distributed::ResponseType sync_type() const;
  inline void set_sync_type(::peloton::distributed::ResponseType value);
  ...
  // @@protoc_insertion_point(class_scope:peloton.distributed.LogRecordReplayRequest)
 private:
...
class LogRecordReplayResponse : public ::google::protobuf::Message {
 ...
 public:
  ...
  // @@protoc_insertion_point(class_scope:peloton.distributed.LogRecordReplayResponse)
 private:
  inline void set_has_sequence_number();
  inline void clear_has_sequence_number();
...
class PelotonLoggingService : public ::google::protobuf::Service {
 ...
 public:
  ...
  virtual void LogRecordReplay(
      ...
      const ::peloton::distributed::LogRecordReplayRequest* request,
      ::peloton::distributed::LogRecordReplayResponse* response,
...
inline ::peloton::distributed::ResponseType LogRecordReplayRequest::sync_type()
    const {
  return static_cast< ::peloton::distributed::ResponseType>(sync_type_);
}
inline void LogRecordReplayRequest::set_sync_type(
    ::peloton::distributed::ResponseType value) {
  assert(::peloton::distributed::ResponseType_IsValid(value));
  set_has_sync_type();
  sync_type_ = value;
}
...
GetEnumDescriptor< ::peloton::distributed::ResponseType>() {
  return ::peloton::distributed::ResponseType_descriptor();
}
template <>
inline const EnumDescriptor*
GetEnumDescriptor< ::peloton::distributed::LoggingStatus>() {
  return ::peloton::distributed::LoggingStatus_descriptor();
}
