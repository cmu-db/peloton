...
class ConjunctionScanPredicate {
 ...
 public:
  ...
  void ConstructScanInterval(Index *index_p,
    ...
    is_point_query_ = FindValueIndex(metadata_p,
                                     tuple_column_id_list,
                                     expr_list,
                                     value_index_list_);
...
class IndexScanPredicate {
 ...
 public:
  ...
  void AddConjunctionScanPredicate(Index *index_p,
    ...
    conjunction_list_.emplace_back(index_p,
                                   value_list,
                                   tuple_column_id_list,
                                   expr_list);
