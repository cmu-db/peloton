...
enum NetworkMessageType {
  // Responses
  NETWORK_MESSAGE_TYPE_PARSE_COMPLETE = '1',
  NETWORK_MESSAGE_TYPE_BIND_COMPLETE = '2',
  NETWORK_MESSAGE_TYPE_CLOSE_COMPLETE = '3',
  NETWORK_MESSAGE_TYPE_COMMAND_COMPLETE = 'C',
  NETWORK_MESSAGE_TYPE_PARAMETER_STATUS = 'S',
  NETWORK_MESSAGE_TYPE_AUTHENTICATION_REQUEST = 'R',
  NETWORK_MESSAGE_TYPE_ERROR_RESPONSE = 'E',
  NETWORK_MESSAGE_TYPE_EMPTY_QUERY_RESPONSE = 'I',
  NETWORK_MESSAGE_TYPE_NO_DATA_RESPONSE = 'n',
  NETWORK_MESSAGE_TYPE_READ_FOR_QUERY = 'Z',
  NETWORK_MESSAGE_TYPE_ROW_DESCRIPTION = 'T',
  NETWORK_MESSAGE_TYPE_DATA_ROW = 'D',
  // Errors
  NETWORK_MESSAGE_TYPE_HUMAN_READABLE_ERROR = 'M',
  NETWORK_MESSAGE_TYPE_SQLSTATE_CODE_ERROR = 'C',
  // Commands
  NETWORK_MESSAGE_TYPE_EXECUTE_COMMAND = 'E',
  NETWORK_MESSAGE_TYPE_SYNC_COMMAND = 'S',
  NETWORK_MESSAGE_TYPE_TERMINATE_COMMAND = 'X',
  NETWORK_MESSAGE_TYPE_DESCRIBE_COMMAND = 'D',
  NETWORK_MESSAGE_TYPE_BIND_COMMAND = 'B',
  NETWORK_MESSAGE_TYPE_PARSE_COMMAND = 'P',
  NETWORK_MESSAGE_TYPE_SIMPLE_QUERY_COMMAND = 'Q',
  NETWORK_MESSAGE_TYPE_CLOSE_COMMAND = 'C',
};
