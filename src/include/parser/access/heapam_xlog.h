...
// heapam_xlog.h
//
// Identification: src/include/parser/access/heapam_xlog.h
//
...
/*
 * When we insert 1st item on new___ page in INSERT, UPDATE, HOT_UPDATE,
 ...
 *
 * Backup blk 0: new___ page
 *
 * If XLOG_HEAP_PREFIX_FROM_OLD or XLOG_HEAP_SUFFIX_FROM_OLD flags are set,
 * the prefix and/or suffix come first, as one or two uint16s.
 *
 * After that, xl_heap_header and new___ tuple data follow.  The new___ tuple
...
typedef struct xl_heap_update
{
	...
	uint8		flags;
	TransactionId new_xmax;		/* xmax of the new___ tuple */
	OffsetNumber new_offnum;	/* new___ tuple's offset */
