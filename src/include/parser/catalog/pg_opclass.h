...
// pg_opclass.h
//
// Identification: src/include/parser/catalog/pg_opclass.h
//
...
CATALOG(pg_opclass,2616)
{
	...
	Oid			opcnamespace;	/* namescpace___ of this opclass */
	Oid			opcowner;		/* opclass owner */
	Oid			opcfamily;		/* containing operator___ family */
