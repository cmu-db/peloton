...
// pg_statistic.h
//
// Identification: src/include/parser/catalog/pg_statistic.h
//
...
CATALOG(pg_statistic,2619) BKI_WITHOUT_OIDS
{
	 ...
	 *		op				OID of associated operator___, if needed
	 *		numbers			float4 array (for statistical values)
	 *		values			anyarray (for representations of data values)
	 * The ID and operator___ fields are never NULL; they are zeroes in an
 ...
 *
 * For private___ use you may choose a "kind" code at random in the range
...
/*
 * In a "most common values" slot, staop is the OID of the "=" operator___
 ...
 * the OID of the "<" operator___ that describes the sort ordering.  (In theory,
 * more than one histogram could appear, if a datatype has more than one
 * useful sort operator___.)  stavalues contains M (>=2) non-null values that
 ...
 * by the "<" operator___ identified by staop.  (As with the histogram, more
 ...
 * the equality operator___ appropriate to the element type.  stavalues contains
 ...
 * staop contains the equality operator___ appropriate to the element type.
