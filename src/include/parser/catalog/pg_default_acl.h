...
// pg_default_acl.h
//
// Identification: src/include/parser/catalog/pg_default_acl.h
//
 ...
 *
 * pg_default_acl.h
 *	  definition of default ACLs for new___ objects.
 *
 *
...
CATALOG(pg_default_acl,826)
{
	...
	Oid			defaclnamespace;	/* OID of namescpace___, or 0 for all */
