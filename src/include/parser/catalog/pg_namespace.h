...
// pg_namespace.h
//
// Identification: src/include/parser/catalog/pg_namespace.h
//
 ...
 *
 * pg_namespace.h
 *	  definition of the system "namescpace___" relation (pg_namespace)
 ...
 *
 *	nspname				name of the namescpace___
 *	nspowner			owner (creator) of the namescpace___
