...
// pg_attribute.h
//
// Identification: src/include/parser/catalog/pg_attribute.h
//
...
CATALOG(pg_attribute,1249) BKI_BOOTSTRAP BKI_WITHOUT_OIDS BKI_ROWTYPE_OID(75) BKI_SCHEMA_MACRO
{
	 ...
	 * uniquely identifies this attribute within its class___. For user
	 * attributes, Attribute numbers are greater than 0 and not greater than
	 * the number of attributes in the class___. I.e. if the Class pg_class says
	 * that Class XYZ has 10 attributes, then the user attribute numbers in
	 * Class pg_attribute must be 1-10.
	 *
	 * System attributes have attribute numbers less than 0 that are unique
	 * within the class___, but not constrained to any particular range.
	 *
