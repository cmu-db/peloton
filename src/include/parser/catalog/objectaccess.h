...
// objectaccess.h
//
// Identification: src/include/parser/catalog/objectaccess.h
//
 ...
 * and can use SnapshotSelf to get the new___ version of the tuple.
 *
 * OAT_NAMESPACE_SEARCH should be invoked prior to object name lookup under
 * a particular namescpace___. This event is equivalent to usage permission
