...
// pg_control.h
//
// Identification: src/include/parser/catalog/pg_control.h
//
...
#include "parser/pgtime.h"				/* for pg_time_t */
#include "parser/port/pg_crc32c.h"
...
typedef struct CheckPoint
{
	...
	TimeLineID	PrevTimeLineID; /* previous TLI, if this record begins a new___
