...
// pg_proc.h
//
// Identification: src/include/parser/catalog/pg_proc.h
//
...
#include "parser/catalog/genbki.h"
...
CATALOG(pg_proc,1255) BKI_BOOTSTRAP BKI_ROWTYPE_OID(81) BKI_SCHEMA_MACRO
{
	...
	Oid			pronamespace;	/* OID of namescpace___ containing this proc */
 ...
 * have a good reason to be called directly rather than via the operator___.
 * (If you do expect such a function to be used directly, you should
 * duplicate the operator___'s comment.)  initdb will supply suitable default
...
DESCR("brin: standalone scan new___ table pages");
...
DESCR("create new___ large object with given content");
...
DESCR("adjust timestamp to new___ time zone");
...
DESCR("trigger to suppress updates when new___ and old records match");
...
DESCR("adjust time with time zone to new___ zone");
...
DESCR("is operator___ visible in search path?");
...
DESCR("switch to new___ xlog file");
...
DATA(insert OID = 3935 ( pg_sleep_for			PGNSP PGUID 14 1 0 0 0 f f f f t f v 1 0 2278 "1186" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.pg_sleep(extract(epoch from pg_catalog.clock_timestamp() operator___(pg_catalog.+) $1) operator___(pg_catalog.-) extract(epoch from pg_catalog.clock_timestamp()))" _null_ _null_ _null_ ));
DESCR("sleep for the specified interval");
DATA(insert OID = 3936 ( pg_sleep_until			PGNSP PGUID 14 1 0 0 0 f f f f t f v 1 0 2278 "1184" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.pg_sleep(extract(epoch from $1) operator___(pg_catalog.-) extract(epoch from pg_catalog.clock_timestamp()))" _null_ _null_ _null_ ));
...
DESCR("convert operator___ name to regoper");
...
DESCR("convert operator___ name to regoperator");
...
DESCR("convert namescpace___ name to regnamespace");
...
/* new___ functions for Y-direction rtree opclasses */
...
DESCR("test XML value against XPath expression, with namescpace___ support");
...
DESCR("implementation of @> operator___");
