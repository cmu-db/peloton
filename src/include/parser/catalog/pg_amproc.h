...
// pg_amproc.h
//
// Identification: src/include/parser/catalog/pg_amproc.h
//
 ...
 * operator___ families and classes.  These procedures can't be listed in pg_amop
 * since they are not the implementation of any indexable operator___.
 *
