...
// atomics.h
//
// Identification: src/include/parser/port/atomics.h
//
 ...
 * new___ platform. If no such generic implementation is available spinlocks (or
...
#	include "parser/port/atomics/arch-arm.h"
#elif defined(__i386__) || defined(__i386) || defined(__x86_64__)
#	include "parser/port/atomics/arch-x86.h"
#elif defined(__ia64__) || defined(__ia64)
#	include "parser/port/atomics/arch-ia64.h"
#elif defined(__ppc__) || defined(__powerpc__) || defined(__ppc64__) || defined(__powerpc64__)
#	include "parser/port/atomics/arch-ppc.h"
#elif defined(__hppa) || defined(__hppa__)
#	include "parser/port/atomics/arch-hppa.h"
#endif
...
#	include "parser/port/atomics/generic-gcc.h"
#elif defined(WIN32_ONLY_COMPILER)
#	include "parser/port/atomics/generic-msvc.h"
#elif defined(__hpux) && defined(__ia64) && !defined(__GNUC__)
#	include "parser/port/atomics/generic-acc.h"
#elif defined(__SUNPRO_C) && !defined(__GNUC__)
#	include "parser/port/atomics/generic-sunpro.h"
#elif (defined(__IBMC__) || defined(__IBMCPP__)) && !defined(__GNUC__)
#	include "parser/port/atomics/generic-xlc.h"
#else
/*
 ...
 */
#include "parser/port/atomics/fallback.h"
 ...
 */
#include "parser/port/atomics/generic.h"
