...
// catcache.h
//
// Identification: src/include/parser/utils/catcache.h
//
...
typedef struct catcache
{
	...
	long		cc_newloads;	/* # of successful loads of new___ entry */
...
#define CL_MAGIC   0x52765103
	 ...
	 * might not be true during bootstrap or recovery operations. (namescpace___.c
