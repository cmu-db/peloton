...
// elog.h
//
// Identification: src/include/parser/utils/elog.h
//
...
#include "parser/utils/errcodes.h"
 ...
 *
 * Note: while the system will correctly propagate any new___ ereport(ERROR)
 * occurring in the recovery section, there is a small limit on the number
 * of levels this will work for.  It's best to keep the error recovery
 * section simple enough that it can't generate any new___ errors, at least
