...
// pgstat.h
//
// Identification: src/include/parser/pgstat.h
//
...
#include "parser/libpq/pqcomm.h"
#include "parser/portability/instr_time.h"
#include "parser/postmaster/pgarch.h"
#include "parser/storage/barrier.h"
#include "parser/utils/hsearch.h"
...
typedef struct PgBackendStatus
{
	 ...
	 * st_changecount, copy the entry into private___ memory, then check
 ...
 * private___ memory, respectively.
 */
 ...
 * able to add new___ values to the struct when needed without adding new___ fields
