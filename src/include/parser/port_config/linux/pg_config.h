...
// pg_config.h
//
// Identification: src/include/parser/port_config/linux/pg_config.h
//
...
#define PG_VERSION_STR "PostgreSQL 9.5devel on x86_64-unknown-linux-gnu, compiled by gcc (Ubuntu 4.9.2-0ubuntu1~14.04) 4.9.2, 64-bit"
