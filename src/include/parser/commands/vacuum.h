...
// vacuum.h
//
// Identification: src/include/parser/commands/vacuum.h
//
...
#include "parser/catalog/pg_statistic.h"
...
typedef struct VacAttrStats
{
	...
	/*
	 * These fields are private___ to the main ANALYZE code and should not be
