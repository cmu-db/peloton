...
// ilist.h
//
// Identification: src/include/parser/lib/ilist.h
//
 ...
 */
STATIC_IF_INLINE dlist_node *
dlist_next_node(dlist_head *head __attribute__((unused)) , dlist_node *node)
{
 ...
 */
STATIC_IF_INLINE dlist_node *
dlist_prev_node(dlist_head *head __attribute__((unused)), dlist_node *node)
{
 ...
 */
STATIC_IF_INLINE slist_node *
slist_next_node(slist_head *head __attribute__((unused)), slist_node *node)
{
