...
// pg_wchar.h
//
// Identification: src/include/parser/mb/pg_wchar.h
//
 ...
 *	  is a private___-charset flag, LC12 is an identifier for the charset,
 ...
 *	  where LCPRV2 is a private___-charset flag, LC22 is an identifier for
 ...
 * the XEmacs project; "private___" encodings have Postgres-specific charset
 * identifiers.
 *
 ...
 * private___-charset flag values do not match what XEmacs says they should be,
 * so this isn't really exactly MULE (not that private___ charsets would be
...
/*
 * Postgres-specific prefix bytes for "private___" single byte encodings
...
/*
 * Postgres-specific prefix bytes for "private___" multibyte encodings
...
/*
 * Charset IDs for private___ single byte encodings (0xa0-0xef)
 */
...
/*
 * Charset IDs for private___ multibyte encodings (0xf0-0xff)
 */
