...
class TimestampCheckpointManager : public CheckpointManager {
 ...
 protected:
  ...
  size_t CheckpointingDatabaseCatalog(catalog::DatabaseCatalogObject *target_db, const oid_t table_count, FileHandle &file_handle);
  size_t CheckpointingTableCatalog(catalog::TableCatalogObject *target_table, catalog::Schema *schema, const size_t table_size, FileHandle &file_handle);
