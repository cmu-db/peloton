...
class Value : public Printable {
 public:
  ...
  virtual Value *CompareEquals(const Value &o) const = 0;
  virtual Value *CompareNotEquals(const Value &o) const = 0;
  virtual Value *CompareLessThan(const Value &o) const = 0;
  virtual Value *CompareLessThanEquals(const Value &o) const = 0;
  virtual Value *CompareGreaterThan(const Value &o) const = 0;
  virtual Value *CompareGreaterThanEquals(const Value &o) const = 0;
  ...
  virtual void HashCombine(size_t &seed) const = 0;
  ...
  virtual void SerializeTo(char *storage, bool inlined,
                           VarlenPool *pool) const = 0;
  virtual void SerializeTo(SerializeOutput &out) const = 0;
  ...
  virtual Value *CastAs(const Type::TypeId type_id) const = 0;
