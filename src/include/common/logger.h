 ...
 * these are just printf() turned on/off by LOG_LOG_LEVEL compile option.
...
// Compile Option
#ifndef LOG_LOG_LEVEL
    // TODO : any way to use pragma message in GCC?
    //#pragma message("Warning: LOG_LOG_LEVEL compile option was not explicitly given.")
    #if defined(DEBUG) || defined(_DEBUG) || defined(_DEBUG_)
        //#pragma message("LOG_LEVEL_DEBUG is used instead as DEBUG option is on.")
        #define LOG_LOG_LEVEL LOG_LEVEL_DEBUG
    #else
        //#pragma message("LOG_LEVEL_WARN is used instead as DEBUG option is off.")
        #define LOG_LOG_LEVEL LOG_LEVEL_WARN
    #endif
    //#pragma message("Give LOG_LOG_LEVEL compile option to overwrite the default level.")
#endif
...
#endif
#if LOG_LOG_LEVEL<=LOG_LEVEL_ERROR
...
#endif
#if LOG_LOG_LEVEL<=LOG_LEVEL_WARN
...
#endif
#if LOG_LOG_LEVEL<=LOG_LEVEL_INFO
...
#endif
#if LOG_LOG_LEVEL<=LOG_LEVEL_DEBUG
...
#endif
#if LOG_LOG_LEVEL<=LOG_LEVEL_TRACE
