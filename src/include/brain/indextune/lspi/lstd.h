 ...
 *  [2] Linear Least-Squares Algorithms for Temporal Difference Learning by
 *Barto et. al.(Page 13) The Least Squares TD Estimator(based on the Recursive
 *least squares formulation) provides an efficient way to evaluate the value
 *function of a parameterized state.
...
class LSTDModel {
 public:
  explicit LSTDModel(size_t feat_len, double variance_init = 1e-3,
                     double gamma = 0.9999);
