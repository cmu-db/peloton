...
class NetworkManager {
 public:
  ...
  // Returns a vector of all the PreparedStatements that this NetworkManager has
  ...
  static std::vector<NetworkManager*> GetNetworkManagers() {
    return (NetworkManager::network_managers_);
  }
 ...
 private:
  ...
  // HACK: Global list of NetworkManager instances
  ...
  static std::vector<NetworkManager*> network_managers_;
