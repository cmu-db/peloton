...
public:
  ...
  static double GreaterThanOrEqualTo(const std::shared_ptr<TableStats>& table_stats,
  const ValueCondition& condition) {
  ...
  static double In(UNUSED_ATTRIBUTE const std::shared_ptr<TableStats>& table_stats,
