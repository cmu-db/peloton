...
class FormatTransformer {
 public:
  ...
  static PelotonValueFormat TransformValueFormat(
      PostgresValueFormat postgresValueFormat);
};

class PostgresValueFormat {
 public:
  PostgresValueFormat(oid_t postgres_value_type_id, int postgres_column_length,
...
class PelotonValueFormat {
 public:
  PelotonValueFormat(ValueType peloton_value_type, int peloton_column_length,
