...
namespace peloton {
  ...
  namespace planner {
    ...
    public:
      ...
      // # 623
      explicit DropPlan(std::string name, concurrency::Transaction *consistentTxn = nullptr);

      explicit DropPlan(parser::DropStatement *parse_tree, concurrency::Transaction *consistentTxn = nullptr);
