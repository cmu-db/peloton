...
namespace peloton {
  ...
  namespace planner {
    ...
    public:
      ...
      explicit AnalyzePlan(std::string table_name, concurrency::Transaction *consistentTxn = nullptr);

      explicit AnalyzePlan(std::string table_name, std::vector<char*> column_names, concurrency::Transaction *consistentTxn = nullptr);

      explicit AnalyzePlan(parser::AnalyzeStatement *parse_tree, concurrency::Transaction *consistentTxn = nullptr);
