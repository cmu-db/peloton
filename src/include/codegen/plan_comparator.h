...
private:
  ...
  static int CompareHashJoin (const planner::HashJoinPlan &, const planner::HashJoinPlan &);

  //Helper compare functions
  static int CompareProjectInfo (const planner::ProjectInfo *, const planner::ProjectInfo *);
  static int CompareDerivedAttr (const planner::DerivedAttribute &, const planner::DerivedAttribute &);
  static int CompareAggType (const std::vector<planner::AggregatePlan::AggTerm> &,
                             const std::vector<planner::AggregatePlan::AggTerm> &);
  static int CompareSchema (const catalog::Schema &, const catalog::Schema &);
  static int CompareChildren (const planner::AbstractPlan &, const planner::AbstractPlan &);
