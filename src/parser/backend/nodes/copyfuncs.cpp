...
// copyfuncs.cpp
//
// Identification: src/parser/backend/nodes/copyfuncs.cpp
//
...
#include "parser/nodes/plannodes.h"
#include "parser/nodes/relation.h"
#include "parser/utils/datum.h"
...
_copyPlannedStmt(const PlannedStmt *from) {
  ...
  COPY_SCALAR_FIELD(pelotonQuery);  // Peloton Change: also copy pelotonQuery flag
...
_copyConst(const Const *from) {
  ...
  if (from->constbyval || from->constisnull) {
     ...
     */
    newnode->constvalue = datumCopy(from->constvalue, from->constbyval,
                                    from->constlen);
  }
...
_copyTypeName(const TypeName *from) {
  ...
  COPY_SCALAR_FIELD(type_oid);
  COPY_SCALAR_FIELD(type_len);
...
_copyAlterTableStmt(const AlterTableStmt *from) {
  ...
  // TODO: Peloton Changes
  COPY_SCALAR_FIELD(relation_id);
  COPY_NODE_FIELD(stmts);
 ...
 */
#define COPY_NODE_CELL(new___, old)					\
	(new___) = (ListCell *) palloc(sizeof(ListCell));	\
	lfirst(new___) = copyObject(lfirst(old));
...
_copyList(const List *from) {
  ...
  new___ = makeNode(List);
  new___->length = from->length;

  COPY_NODE_CELL(new___->head, from->head);
  prev_new = new___->head;
  ...
  switch (nodeTag(from)) {
    ...
    case T_ScalarArrayOpExpr:
      retval = _copyScalarArrayOpExpr(
          static_cast<const ScalarArrayOpExpr *>(from));
      break;
    case T_BoolExpr:
    ...
    case T_AlternativeSubPlan:
      retval = _copyAlternativeSubPlan(
          static_cast<const AlternativeSubPlan *>(from));
      break;
    case T_FieldSelect:
    ...
    case T_ConvertRowtypeExpr:
      retval = _copyConvertRowtypeExpr(
          static_cast<const ConvertRowtypeExpr *>(from));
      break;
    case T_CollateExpr:
    ...
    case T_CoerceToDomainValue:
      retval = _copyCoerceToDomainValue(
          static_cast<const CoerceToDomainValue *>(from));
      break;
    case T_SetToDefault:
    ...
    case T_SetOperationStmt:
      retval = _copySetOperationStmt(
          static_cast<const SetOperationStmt *>(from));
      break;
    ...
    case T_AlterDefaultPrivilegesStmt:
      retval = _copyAlterDefaultPrivilegesStmt(
          static_cast<const AlterDefaultPrivilegesStmt *>(from));
      break;
    case T_DeclareCursorStmt:
      retval = _copyDeclareCursorStmt(
          static_cast<const DeclareCursorStmt *>(from));
      break;
    ...
    case T_CreateFunctionStmt:
      retval = _copyCreateFunctionStmt(
          static_cast<const CreateFunctionStmt *>(from));
      break;
    case T_FunctionParameter:
      retval = _copyFunctionParameter(
          static_cast<const FunctionParameter *>(from));
      break;
    case T_AlterFunctionStmt:
      retval = _copyAlterFunctionStmt(
          static_cast<const AlterFunctionStmt *>(from));
      break;
    case T_DoStmt:
    ...
    case T_AlterObjectSchemaStmt:
      retval = _copyAlterObjectSchemaStmt(
          static_cast<const AlterObjectSchemaStmt *>(from));
      break;
    ...
    case T_CompositeTypeStmt:
      retval = _copyCompositeTypeStmt(
          static_cast<const CompositeTypeStmt *>(from));
      break;
    ...
    case T_CreateDomainStmt:
      retval = _copyCreateDomainStmt(
          static_cast<const CreateDomainStmt *>(from));
      break;
    case T_CreateOpClassStmt:
      retval = _copyCreateOpClassStmt(
          static_cast<const CreateOpClassStmt *>(from));
      break;
    case T_CreateOpClassItem:
      retval = _copyCreateOpClassItem(
          static_cast<const CreateOpClassItem *>(from));
      break;
    case T_CreateOpFamilyStmt:
      retval = _copyCreateOpFamilyStmt(
          static_cast<const CreateOpFamilyStmt *>(from));
      break;
    case T_AlterOpFamilyStmt:
      retval = _copyAlterOpFamilyStmt(
          static_cast<const AlterOpFamilyStmt *>(from));
      break;
    case T_CreatedbStmt:
      retval = _copyCreatedbStmt(static_cast<const CreatedbStmt *>(from));
      break;
    case T_AlterDatabaseStmt:
      retval = _copyAlterDatabaseStmt(
          static_cast<const AlterDatabaseStmt *>(from));
      break;
    case T_AlterDatabaseSetStmt:
      retval = _copyAlterDatabaseSetStmt(
          static_cast<const AlterDatabaseSetStmt *>(from));
      break;
    case T_DropdbStmt:
    ...
    case T_CreateTableAsStmt:
      retval = _copyCreateTableAsStmt(
          static_cast<const CreateTableAsStmt *>(from));
      break;
    case T_RefreshMatViewStmt:
      retval = _copyRefreshMatViewStmt(
          static_cast<const RefreshMatViewStmt *>(from));
      break;
    case T_ReplicaIdentityStmt:
      retval = _copyReplicaIdentityStmt(
          static_cast<const ReplicaIdentityStmt *>(from));
      break;
    ...
    case T_VariableShowStmt:
      retval = _copyVariableShowStmt(
          static_cast<const VariableShowStmt *>(from));
      break;
    case T_DiscardStmt:
      retval = _copyDiscardStmt(static_cast<const DiscardStmt *>(from));
      break;
    case T_CreateTableSpaceStmt:
      retval = _copyCreateTableSpaceStmt(
          static_cast<const CreateTableSpaceStmt *>(from));
      break;
    case T_DropTableSpaceStmt:
      retval = _copyDropTableSpaceStmt(
          static_cast<const DropTableSpaceStmt *>(from));
      break;
    case T_AlterTableSpaceOptionsStmt:
      retval = _copyAlterTableSpaceOptionsStmt(
          static_cast<const AlterTableSpaceOptionsStmt *>(from));
      break;
    case T_AlterTableMoveAllStmt:
      retval = _copyAlterTableMoveAllStmt(
          static_cast<const AlterTableMoveAllStmt *>(from));
      break;
    case T_CreateExtensionStmt:
      retval = _copyCreateExtensionStmt(
          static_cast<const CreateExtensionStmt *>(from));
      break;
    case T_AlterExtensionStmt:
      retval = _copyAlterExtensionStmt(
          static_cast<const AlterExtensionStmt *>(from));
      break;
    case T_AlterExtensionContentsStmt:
      retval = _copyAlterExtensionContentsStmt(
          static_cast<const AlterExtensionContentsStmt *>(from));
      break;
    ...
    case T_CreateForeignServerStmt:
      retval = _copyCreateForeignServerStmt(
          static_cast<const CreateForeignServerStmt *>(from));
      break;
    case T_AlterForeignServerStmt:
      retval = _copyAlterForeignServerStmt(
          static_cast<const AlterForeignServerStmt *>(from));
      break;
    case T_CreateUserMappingStmt:
      retval = _copyCreateUserMappingStmt(
          static_cast<const CreateUserMappingStmt *>(from));
      break;
    case T_AlterUserMappingStmt:
      retval = _copyAlterUserMappingStmt(
          static_cast<const AlterUserMappingStmt *>(from));
      break;
    case T_DropUserMappingStmt:
      retval = _copyDropUserMappingStmt(
          static_cast<const DropUserMappingStmt *>(from));
      break;
    case T_CreateForeignTableStmt:
      retval = _copyCreateForeignTableStmt(
          static_cast<const CreateForeignTableStmt *>(from));
      break;
    case T_ImportForeignSchemaStmt:
      retval = _copyImportForeignSchemaStmt(
          static_cast<const ImportForeignSchemaStmt *>(from));
      break;
    case T_CreateTransformStmt:
      retval = _copyCreateTransformStmt(
          static_cast<const CreateTransformStmt *>(from));
      break;
    case T_CreateTrigStmt:
      retval = _copyCreateTrigStmt(static_cast<const CreateTrigStmt *>(from));
      break;
    case T_CreateEventTrigStmt:
      retval = _copyCreateEventTrigStmt(
          static_cast<const CreateEventTrigStmt *>(from));
      break;
    case T_AlterEventTrigStmt:
      retval = _copyAlterEventTrigStmt(
          static_cast<const AlterEventTrigStmt *>(from));
      break;
    ...
    case T_AlterRoleSetStmt:
      retval = _copyAlterRoleSetStmt(
          static_cast<const AlterRoleSetStmt *>(from));
      break;
    case T_DropRoleStmt:
    ...
    case T_ConstraintsSetStmt:
      retval = _copyConstraintsSetStmt(
          static_cast<const ConstraintsSetStmt *>(from));
      break;
    case T_ReindexStmt:
    ...
    case T_CreateSchemaStmt:
      retval = _copyCreateSchemaStmt(
          static_cast<const CreateSchemaStmt *>(from));
      break;
    case T_CreateConversionStmt:
      retval = _copyCreateConversionStmt(
          static_cast<const CreateConversionStmt *>(from));
      break;
    ...
    case T_ReassignOwnedStmt:
      retval = _copyReassignOwnedStmt(
          static_cast<const ReassignOwnedStmt *>(from));
      break;
    case T_AlterTSDictionaryStmt:
      retval = _copyAlterTSDictionaryStmt(
          static_cast<const AlterTSDictionaryStmt *>(from));
      break;
    case T_AlterTSConfigurationStmt:
      retval = _copyAlterTSConfigurationStmt(
          static_cast<const AlterTSConfigurationStmt *>(from));
      break;
    case T_CreatePolicyStmt:
      retval = _copyCreatePolicyStmt(
          static_cast<const CreatePolicyStmt *>(from));
      break;
    ...
    case T_RangeTblFunction:
      retval = _copyRangeTblFunction(
          static_cast<const RangeTblFunction *>(from));
      break;
    ...
    case T_OnConflictClause:
      retval = _copyOnConflictClause(
          static_cast<const OnConflictClause *>(from));
      break;
    case T_CommonTableExpr:
      retval = _copyCommonTableExpr(static_cast<const CommonTableExpr *>(from));
      break;
    case T_RangeTableSample:
      retval = _copyRangeTableSample(
          static_cast<const RangeTableSample *>(from));
      break;
    case T_TableSampleClause:
      retval = _copyTableSampleClause(
          static_cast<const TableSampleClause *>(from));
      break;
    case T_FuncWithArgs:
