...
// name.cpp
//
// Identification: src/parser/backend/utils/adt/name.cpp
//
...
#include "parser/catalog/pg_type.h"
#include "parser/libpq/pqformat.h"
...
current_schema(PG_FUNCTION_ARGS)
{
	...
	if (!nspname)
		PG_RETURN_NULL();		/* recently-deleted namescpace___? */
...
current_schemas(PG_FUNCTION_ARGS)
{
	...
	foreach(l, search_path)
	{
		...
		if (nspname)			/* watch out for deleted namescpace___ */
		{
