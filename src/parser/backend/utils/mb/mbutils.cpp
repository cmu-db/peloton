...
// mbutils.cpp
//
// Identification: src/parser/backend/utils/mb/mbutils.cpp
//
...
#include "parser/utils/syscache.h"
 ...
 */
thread_local static bool backend_startup_complete = false;
...
PrepareClientEncoding(int encoding)
{
	...
	if (IsTransactionState())
	{
		...
		/* Attach new___ info to head of list */
 ...
 * Return the MessageEncoding implied by the new___ settings.
 *
