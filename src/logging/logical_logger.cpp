...
// // logical_logger.cpp
// //
// // Identification: src/logging/logical_logger.cpp
// //
...
// #include "logging/phylog_logger.h"

// namespace peloton {
// namespace logging {

// void LogicalLogger::RegisterWorker(WorkerContext *phylog_worker_ctx) {
//   worker_map_lock_.Lock();
//   worker_map_[phylog_worker_ctx->worker_id].reset(phylog_worker_ctx);
//   worker_map_lock_.Unlock();
// }

// void LogicalLogger::DeregisterWorker(WorkerContext *phylog_worker_ctx) {
//   worker_map_lock_.Lock();
//   worker_map_.erase(phylog_worker_ctx->worker_id);
//   worker_map_lock_.Unlock();
// }

// void LogicalLogger::StartIndexRebulding(const size_t logger_count) {
//   PL_ASSERT(recovery_threads_.size() != 0);
//   recovery_threads_[0].reset(new std::thread(&LogicalLogger::RunSecIndexRebuildThread, this, logger_count));
// }

// void LogicalLogger::WaitForIndexRebuilding() {
//   recovery_threads_[0]->join();
// }

// void LogicalLogger::StartRecovery(const size_t checkpoint_eid, const size_t persist_eid, const size_t recovery_thread_count) {
...
//     recovery_threads_[i].reset(new std::thread(&LogicalLogger::RunRecoveryThread, this, i, checkpoint_eid, persist_eid));
//   }
// }

// void LogicalLogger::WaitForRecovery() {
...
// void LogicalLogger::GetSortedLogFileIdList(const size_t checkpoint_eid, const size_t persist_eid) {
//   // Open the log dir
//   struct dirent *file;
//   DIR *dirp;
...
// txn_id_t LogicalLogger::LockTuple(storage::TileGroupHeader *tg_header, oid_t tuple_offset) {
...
// void LogicalLogger::UnlockTuple(storage::TileGroupHeader *tg_header, oid_t tuple_offset, txn_id_t new_txn_id) {
...
// bool LogicalLogger::InstallTupleRecord(LogRecordType type, storage::Tuple *tuple, storage::DataTable *table, cid_t cur_cid) {
...
// bool LogicalLogger::ReplayLogFile(const size_t thread_id, FileHandle &file_handle, size_t checkpoint_eid, size_t persist_eid) {
...
// void LogicalLogger::RunRecoveryThread(const size_t thread_id, const size_t checkpoint_eid, const size_t persist_eid) {
...
// void LogicalLogger::RunSecIndexRebuildThread(const size_t logger_count) {
...
// void LogicalLogger::RebuildSecIndexForTable(const size_t logger_count, storage::DataTable *table) {
...
// void LogicalLogger::PersistEpochBegin(FileHandle &file_handle, const size_t epoch_id) {
...
// void LogicalLogger::PersistEpochEnd(FileHandle &file_handle, const size_t epoch_id) {
...
// void LogicalLogger::PersistLogBuffer(FileHandle &file_handle, std::unique_ptr<LogBuffer> log_buffer) {
