...
ProcessPacketResult ProtocolHandler::ExecQueryMessage(InputPacket *pkt, const size_t thread_id) {
  std::string query;
...
ProcessPacketResult ProtocolHandler::ExecDescribeMessage(InputPacket *pkt) {
  if (skipped_stmt_) {
