...
LSPIIndexTuner::LSPIIndexTuner(
    ...
    : db_name_(db_name) {
  index_config_ =
      std::make_shared<CompressedIndexConfiguration>(db_name, cat, txn_manager);
...
// void LSPIIndexTuner::Tune(UNUSED_ATTRIBUTE std::vector<std::pair<std::string,
// double>> query_latency_pairs) {
//  UNUSED_ATTRIBUTE auto current_config =
