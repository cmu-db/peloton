...
bool RunPayment(const size_t &thread_id) {
  ...
  warehouse_bal.expr = expression::ExpressionUtil::ConstantValueFactory(
  ...
  district_bal.expr = expression::ExpressionUtil::ConstantValueFactory(
