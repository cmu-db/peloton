...
extern bool expression_tree_walker(
    Node *node, bool (*walker)(Node *, void *), /* Peloton porting: change
                                                   function pointer to contain
                                                   two arguments */
    void *context);
...
extern Node *expression_tree_mutator(
    Node *node,
    Node *(*mutator)(Node *, void *), /* Peloton porting: change function
                                         pointer to contain two arguments */
    void *context);

typedef bool (*query_tree_walker_fptr)(Node *, void *);
extern bool query_tree_walker(
    Query *query, bool (*walker)(Node *,
                                 void *), /* Peloton porting: change function
                                             pointer to contain two arguments */
    void *context,
    int flags);
...
extern Query *query_tree_mutator(
    Query *query, Node *(*mutator)(Node *, void *), /* Peloton porting: change
                                                       function pointer to
...
extern List *range_table_mutator(
    List *rtable, Node *(*mutator)(Node *, void *), /* Peloton porting: change
                                                       function pointer to
                                                       contain two arguments */
    void *context,
    int flags);
