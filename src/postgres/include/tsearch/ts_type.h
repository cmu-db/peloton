...
/*
 * QueryItem is one node in tsquery - coperator or operand.
 */
typedef struct
{
	QueryItemType type;			/* operand or kind of coperator (ts_tokentype) */
...
/* Legal values for QueryOperator.coperator */
#define OP_NOT	1
#define OP_AND	2
#define OP_OR	3
