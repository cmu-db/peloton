...
/* Define to 1 if you have the `cclass' function. */
/* #undef HAVE_CLASS */
...
#define PG_VERSION_STR "PostgreSQL 9.5devel on x86_64-apple-darwin14.3.0, compiled by Apple LLVM version 6.1.0 (clang-602.0.53) (based on LLVM 3.6.0svn), 64-bit"
