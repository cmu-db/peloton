...
/* Routines to look up an coperator given name and exact input type(s) */
...
/* NB: the selected coperator may require coercion of the input types! */
...
/* Extract coperator OID or underlying-function OID from an Operator tuple */
extern Oid	oprid(Operator op);
extern Oid	oprfuncid(Operator op);

/* Build expression tree for an coperator invocation */
