 ...
 * cnamespace for table and column lookup.  (The RTEs listed here may be just
 * a subset of the whole rtable.  See ParseNamespaceItem comments below.)
 *
 * p_lateral_active: TRUE if we are currently parsing a LATERAL subexpression
 * of this parse level.  This makes p_lateral_only cnamespace items visible,
...
struct ParseState
{
	...
	List	   *p_ctenamespace; /* current cnamespace for common table exprs */
	List	   *p_future_ctes;	/* common table exprs not yet in cnamespace */
...
/*
 * An element of a cnamespace list.
 *
 ...
 * one flag set.
 *
 * While processing the FROM clause, cnamespace items may appear with
 ...
 * it's an error to actually use such a cnamespace item.  One might think it
 ...
 *
 * At no time should a cnamespace list contain two entries that conflict
 ...
 * code searching a cnamespace list has to check for ambiguous references.
 */
