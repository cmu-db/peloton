...
typedef struct {/* ASSERT statement */
  int cmd_type;
  int lineno;
  PLpgSQL_expr *cond;
...
extern bool plpgsql_parse_word(char *word1, const char *yytxt, PLwdatum *wdatum,
                               PLword *word);
extern bool plpgsql_parse_dblword(char *word1, char *word2, PLwdatum *wdatum,
                                  PLcword *cword);
...
extern void plpgsql_adddatum(PLpgSQL_datum *new_datum);
...
extern void plpgsql_exec_get_datum_type_info(PLpgSQL_execstate *estate,
                                             PLpgSQL_datum *datum, Oid *type_id,
...
extern void plpgsql_append_source_text(StringInfo buf, int startlocation,
                                       int endlocation);
