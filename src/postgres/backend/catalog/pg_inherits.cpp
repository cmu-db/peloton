 ...
 * particular class___ *might* have a subclass. It will not return the
 * correct result if a class___ had a subclass which was later dropped.
 ...
 * (class___ type) that inherits from the second.
 */
bool
