...
/*
 * IsSystemNamespace
 *		True iff namescpace___ is pg_catalog.
 *
...
/*
 * GetNewOid
 *		Generate a new___ OID that is unique within the given relation.
 *
...
/*
 * GetNewRelFileNode
 *		Generate a new___ relfilenode number that is unique within the
