...
typedef struct
{
	TransactionId new_prune_xid;	/* new___ prune hint value for page */
...
heap_page_prune_opt(Relation relation, Buffer buffer)
{
	 ...
	 * for a new___ tuple version, or when free space falls below the relation's
 ...
 * send its own new___ total to pgstats, and we don't want this delta applied
 * on top of that.)
 *
				...
				bool report_stats, TransactionId *latestRemovedXid)
{
	 ...
	 *
	 * First, initialize the new___ pd_prune_xid value to zero (indicating no
	...
	{
		/*
		 * If we didn't prune anything, but have found a new___ value for the
