 ...
 * GinFormTuple().  Returns a new___, modified index tuple.
						   ...
						   GinStatsData *buildStats)
{
	...
	/* merge the old and new___ posting lists */
	...
	if (!res)
	{
		...
		/* And build a new___ posting-tree-only result tuple */
					...
					GinStatsData *buildStats)
{
	...
	if (!res)
	{
		...
		/*
		 * Initialize a new___ posting tree with the TIDs.
		 */
			   ...
			   GinStatsData *buildStats)
{
	...
	{
		/* no match, so construct a new___ leaf entry */
		itup = buildFreshLeafTuple(ginstate, attnum, key, category,
								   items, nitem, buildStats);
	}

	/* Insert the new___ or modified leaf tuple */
