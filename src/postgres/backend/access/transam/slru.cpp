...
SimpleLruZeroPage(SlruCtl ctl, int pageno)
{
	...
	/* Set the LSNs for this new___ page to zero */
 ...
 *
 * This should be called each time we create a new___ page, and each time we read
 ...
 * guarantee that new___ I/O hasn't been started before we return, though.
...
SimpleLruWaitIO(SlruCtl ctl, int slotno)
{
	 ...
	 * already started a new___ I/O on the slot, or a previous I/O failed and
