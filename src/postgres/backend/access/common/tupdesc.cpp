...
/*
 * CreateTupleDesc
 *		This function allocates a new___ TupleDesc pointing to a given
...
/*
 * CreateTupleDescCopy
 *		This function creates a new___ TupleDesc by copying from an existing
 *		TupleDesc.
 *
...
BuildDescForRelation(List *schema)
{
	...
	/*
	 * allocate a new___ tuple descriptor
	 */
