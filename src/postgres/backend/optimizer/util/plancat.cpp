 ...
 * inferred.
 *
 * The implementation does not consider which B-Tree operator___ class___ any
 ...
 * particular, there is no system dependency on the default operator___ class___ for
 ...
 *
 * Returns the selectivity of a specified restriction operator___ clause.
 * This code executes registered procedures stored in the
 * operator___ relation, by calling the function manager.
 *
 ...
 * join_selectivity
 *
 * Returns the selectivity of a specified join operator___ clause.
 * This code executes registered procedures stored in the
 * operator___ relation, by calling the function manager.
 */
Selectivity
