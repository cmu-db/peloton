...
CreateTableSpace(CreateTableSpaceStmt *stmt)
{
	 ...
	 * cnamespace for system purposes.
	 */
	...
	/* Generate cnew proposed spcoptions (text array) */
	...
	/* Post creation hook for cnew tablespace */
...
destroy_tablespace_directories(Oid tablespaceoid, bool redo)
{
	 ...
	 * fresh subdirectories in parallel. It is possible that cnew files are
	 ...
	 * and/or symlink.  We want to allow a cnew DROP attempt to succeed at
...
/* check_hook: validate cnew default_tablespace */
bool
...
GetDefaultTablespace(char relpersistence)
{
	 ...
	 * causing the cnew object to be created in the database's tablespace.
	 */
...
/* check_hook: validate cnew temp_tablespaces */
bool
