 ...
 * any WAL entry about the new___ page.  The kernel will already have the
			...
			bool is_heap)
{
	...
	/*
	 * Select offsetNumber to place the new___ item at
	 */
	...
	/*
	 * Compute new___ lower and upper pointers for page, see if it'll fit.
	 *
	 ...
	 * conform, but this is not a necessary coding rule; a new___ index AM could
 ...
 *		reduced by the space needed for a new___ line pointer.
 *
...
PageSetChecksumCopy(Page page, BlockNumber blkno)
{
	 ...
	 */
	if (pageCopy == NULL)
		pageCopy = static_cast<char *>(MemoryContextAlloc(TopMemoryContext, BLCKSZ));
...
/*
 * Set checksum for a page in private___ memory.
 *
