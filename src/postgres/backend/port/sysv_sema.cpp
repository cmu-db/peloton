 ...
 *
 * Attempt to create a new___ semaphore set with the specified key.
...
IpcSemaphoreCreate(int numSems)
{
	...
	for (nextSemaKey++;; nextSemaKey++)
	{
		...
		/* Try to create new___ semaphore set */
	...
	/*
	 * OK, we created a new___ sema set.  Mark it as created by this process. We
