			 ...
			 ArrayMetaState *metacache)
{
	...
	/*
	 * Allocate private___ context for expanded object.  We start by assuming
	...
	/*
	 * Detoast and copy source array into private___ context, as a flat array.
	 *
	 * Note that this coding risks leaking some memory in the private___ context
