...
#define ERRCODE_WARNING_DYNAMIC_RESULT_SETS_RETURNED \
  MAKE_SQLSTATE('0', '1', '0', '0', 'C')
#define ERRCODE_WARNING_IMPLICIT_ZERO_BIT_PADDING \
  MAKE_SQLSTATE('0', '1', '0', '0', '8')
#define ERRCODE_WARNING_NULL_VALUE_ELIMINATED_IN_SET_FUNCTION \
  MAKE_SQLSTATE('0', '1', '0', '0', '3')
#define ERRCODE_WARNING_PRIVILEGE_NOT_GRANTED \
  MAKE_SQLSTATE('0', '1', '0', '0', '7')
#define ERRCODE_WARNING_PRIVILEGE_NOT_REVOKED \
  MAKE_SQLSTATE('0', '1', '0', '0', '6')
#define ERRCODE_WARNING_STRING_DATA_RIGHT_TRUNCATION \
  MAKE_SQLSTATE('0', '1', '0', '0', '4')
#define ERRCODE_WARNING_DEPRECATED_FEATURE \
  MAKE_SQLSTATE('0', '1', 'P', '0', '1')

/* Class 02 - No Data (this is also a warning class___ per the SQL standard) */
#define ERRCODE_NO_DATA MAKE_SQLSTATE('0', '2', '0', '0', '0')
#define ERRCODE_NO_ADDITIONAL_DYNAMIC_RESULT_SETS_RETURNED \
  MAKE_SQLSTATE('0', '2', '0', '0', '1')

/* Class 03 - SQL Statement Not Yet Complete */
#define ERRCODE_SQL_STATEMENT_NOT_YET_COMPLETE \
  MAKE_SQLSTATE('0', '3', '0', '0', '0')
...
#define ERRCODE_SQLSERVER_REJECTED_ESTABLISHMENT_OF_SQLCONNECTION \
  MAKE_SQLSTATE('0', '8', '0', '0', '4')
#define ERRCODE_TRANSACTION_RESOLUTION_UNKNOWN \
  MAKE_SQLSTATE('0', '8', '0', '0', '7')
#define ERRCODE_PROTOCOL_VIOLATION MAKE_SQLSTATE('0', '8', 'P', '0', '1')

/* Class 09 - Triggered Action Exception */
#define ERRCODE_TRIGGERED_ACTION_EXCEPTION \
  MAKE_SQLSTATE('0', '9', '0', '0', '0')
...
#define ERRCODE_INVALID_ROLE_SPECIFICATION \
  MAKE_SQLSTATE('0', 'P', '0', '0', '0')

/* Class 0Z - Diagnostics Exception */
#define ERRCODE_DIAGNOSTICS_EXCEPTION MAKE_SQLSTATE('0', 'Z', '0', '0', '0')
#define ERRCODE_STACKED_DIAGNOSTICS_ACCESSED_WITHOUT_ACTIVE_HANDLER \
  MAKE_SQLSTATE('0', 'Z', '0', '0', '2')
...
#define ERRCODE_CHARACTER_NOT_IN_REPERTOIRE \
  MAKE_SQLSTATE('2', '2', '0', '2', '1')
...
#define ERRCODE_INVALID_ARGUMENT_FOR_NTILE \
  MAKE_SQLSTATE('2', '2', '0', '1', '4')
#define ERRCODE_INVALID_ARGUMENT_FOR_NTH_VALUE \
  MAKE_SQLSTATE('2', '2', '0', '1', '6')
#define ERRCODE_INVALID_ARGUMENT_FOR_POWER_FUNCTION \
  MAKE_SQLSTATE('2', '2', '0', '1', 'F')
#define ERRCODE_INVALID_ARGUMENT_FOR_WIDTH_BUCKET_FUNCTION \
  MAKE_SQLSTATE('2', '2', '0', '1', 'G')
#define ERRCODE_INVALID_CHARACTER_VALUE_FOR_CAST \
  MAKE_SQLSTATE('2', '2', '0', '1', '8')
...
#define ERRCODE_NONSTANDARD_USE_OF_ESCAPE_CHARACTER \
  MAKE_SQLSTATE('2', '2', 'P', '0', '6')
#define ERRCODE_INVALID_INDICATOR_PARAMETER_VALUE \
  MAKE_SQLSTATE('2', '2', '0', '1', '0')
#define ERRCODE_INVALID_PARAMETER_VALUE MAKE_SQLSTATE('2', '2', '0', '2', '3')
#define ERRCODE_INVALID_REGULAR_EXPRESSION \
  MAKE_SQLSTATE('2', '2', '0', '1', 'B')
#define ERRCODE_INVALID_ROW_COUNT_IN_LIMIT_CLAUSE \
  MAKE_SQLSTATE('2', '2', '0', '1', 'W')
#define ERRCODE_INVALID_ROW_COUNT_IN_RESULT_OFFSET_CLAUSE \
  MAKE_SQLSTATE('2', '2', '0', '1', 'X')
#define ERRCODE_INVALID_TABLESAMPLE_ARGUMENT \
  MAKE_SQLSTATE('2', '2', '0', '2', 'H')
#define ERRCODE_INVALID_TABLESAMPLE_REPEAT \
  MAKE_SQLSTATE('2', '2', '0', '2', 'G')
#define ERRCODE_INVALID_TIME_ZONE_DISPLACEMENT_VALUE \
  MAKE_SQLSTATE('2', '2', '0', '0', '9')
#define ERRCODE_INVALID_USE_OF_ESCAPE_CHARACTER \
  MAKE_SQLSTATE('2', '2', '0', '0', 'C')
#define ERRCODE_MOST_SPECIFIC_TYPE_MISMATCH \
  MAKE_SQLSTATE('2', '2', '0', '0', 'G')
#define ERRCODE_NULL_VALUE_NOT_ALLOWED MAKE_SQLSTATE('2', '2', '0', '0', '4')
#define ERRCODE_NULL_VALUE_NO_INDICATOR_PARAMETER \
  MAKE_SQLSTATE('2', '2', '0', '0', '2')
#define ERRCODE_NUMERIC_VALUE_OUT_OF_RANGE \
  MAKE_SQLSTATE('2', '2', '0', '0', '3')
#define ERRCODE_STRING_DATA_LENGTH_MISMATCH \
  MAKE_SQLSTATE('2', '2', '0', '2', '6')
#define ERRCODE_STRING_DATA_RIGHT_TRUNCATION \
  MAKE_SQLSTATE('2', '2', '0', '0', '1')
#define ERRCODE_SUBSTRING_ERROR MAKE_SQLSTATE('2', '2', '0', '1', '1')
#define ERRCODE_TRIM_ERROR MAKE_SQLSTATE('2', '2', '0', '2', '7')
#define ERRCODE_UNTERMINATED_C_STRING MAKE_SQLSTATE('2', '2', '0', '2', '4')
#define ERRCODE_ZERO_LENGTH_CHARACTER_STRING \
  MAKE_SQLSTATE('2', '2', '0', '0', 'F')
#define ERRCODE_FLOATING_POINT_EXCEPTION MAKE_SQLSTATE('2', '2', 'P', '0', '1')
#define ERRCODE_INVALID_TEXT_REPRESENTATION \
  MAKE_SQLSTATE('2', '2', 'P', '0', '2')
#define ERRCODE_INVALID_BINARY_REPRESENTATION \
  MAKE_SQLSTATE('2', '2', 'P', '0', '3')
...
#define ERRCODE_INVALID_XML_PROCESSING_INSTRUCTION \
  MAKE_SQLSTATE('2', '2', '0', '0', 'T')
...
#define ERRCODE_BRANCH_TRANSACTION_ALREADY_ACTIVE \
  MAKE_SQLSTATE('2', '5', '0', '0', '2')
#define ERRCODE_HELD_CURSOR_REQUIRES_SAME_ISOLATION_LEVEL \
  MAKE_SQLSTATE('2', '5', '0', '0', '8')
#define ERRCODE_INAPPROPRIATE_ACCESS_MODE_FOR_BRANCH_TRANSACTION \
  MAKE_SQLSTATE('2', '5', '0', '0', '3')
#define ERRCODE_INAPPROPRIATE_ISOLATION_LEVEL_FOR_BRANCH_TRANSACTION \
  MAKE_SQLSTATE('2', '5', '0', '0', '4')
#define ERRCODE_NO_ACTIVE_SQL_TRANSACTION_FOR_BRANCH_TRANSACTION \
  MAKE_SQLSTATE('2', '5', '0', '0', '5')
#define ERRCODE_READ_ONLY_SQL_TRANSACTION MAKE_SQLSTATE('2', '5', '0', '0', '6')
#define ERRCODE_SCHEMA_AND_DATA_STATEMENT_MIXING_NOT_SUPPORTED \
  MAKE_SQLSTATE('2', '5', '0', '0', '7')
...
#define ERRCODE_IDLE_IN_TRANSACTION_SESSION_TIMEOUT \
  MAKE_SQLSTATE('2', '5', 'P', '0', '3')

/* Class 26 - Invalid SQL Statement Name */
#define ERRCODE_INVALID_SQL_STATEMENT_NAME \
  MAKE_SQLSTATE('2', '6', '0', '0', '0')

/* Class 27 - Triggered Data Change Violation */
#define ERRCODE_TRIGGERED_DATA_CHANGE_VIOLATION \
  MAKE_SQLSTATE('2', '7', '0', '0', '0')

/* Class 28 - Invalid Authorization Specification */
#define ERRCODE_INVALID_AUTHORIZATION_SPECIFICATION \
  MAKE_SQLSTATE('2', '8', '0', '0', '0')
#define ERRCODE_INVALID_PASSWORD MAKE_SQLSTATE('2', '8', 'P', '0', '1')

/* Class 2B - Dependent Privilege Descriptors Still Exist */
#define ERRCODE_DEPENDENT_PRIVILEGE_DESCRIPTORS_STILL_EXIST \
  MAKE_SQLSTATE('2', 'B', '0', '0', '0')
#define ERRCODE_DEPENDENT_OBJECTS_STILL_EXIST \
  MAKE_SQLSTATE('2', 'B', 'P', '0', '1')

/* Class 2D - Invalid Transaction Termination */
#define ERRCODE_INVALID_TRANSACTION_TERMINATION \
  MAKE_SQLSTATE('2', 'D', '0', '0', '0')

/* Class 2F - SQL Routine Exception */
#define ERRCODE_SQL_ROUTINE_EXCEPTION MAKE_SQLSTATE('2', 'F', '0', '0', '0')
#define ERRCODE_S_R_E_FUNCTION_EXECUTED_NO_RETURN_STATEMENT \
  MAKE_SQLSTATE('2', 'F', '0', '0', '5')
#define ERRCODE_S_R_E_MODIFYING_SQL_DATA_NOT_PERMITTED \
  MAKE_SQLSTATE('2', 'F', '0', '0', '2')
#define ERRCODE_S_R_E_PROHIBITED_SQL_STATEMENT_ATTEMPTED \
  MAKE_SQLSTATE('2', 'F', '0', '0', '3')
#define ERRCODE_S_R_E_READING_SQL_DATA_NOT_PERMITTED \
  MAKE_SQLSTATE('2', 'F', '0', '0', '4')

/* Class 34 - Invalid Cursor Name */
#define ERRCODE_INVALID_CURSOR_NAME MAKE_SQLSTATE('3', '4', '0', '0', '0')

/* Class 38 - External Routine Exception */
#define ERRCODE_EXTERNAL_ROUTINE_EXCEPTION \
  MAKE_SQLSTATE('3', '8', '0', '0', '0')
#define ERRCODE_E_R_E_CONTAINING_SQL_NOT_PERMITTED \
  MAKE_SQLSTATE('3', '8', '0', '0', '1')
#define ERRCODE_E_R_E_MODIFYING_SQL_DATA_NOT_PERMITTED \
  MAKE_SQLSTATE('3', '8', '0', '0', '2')
#define ERRCODE_E_R_E_PROHIBITED_SQL_STATEMENT_ATTEMPTED \
  MAKE_SQLSTATE('3', '8', '0', '0', '3')
#define ERRCODE_E_R_E_READING_SQL_DATA_NOT_PERMITTED \
  MAKE_SQLSTATE('3', '8', '0', '0', '4')

/* Class 39 - External Routine Invocation Exception */
#define ERRCODE_EXTERNAL_ROUTINE_INVOCATION_EXCEPTION \
  MAKE_SQLSTATE('3', '9', '0', '0', '0')
#define ERRCODE_E_R_I_E_INVALID_SQLSTATE_RETURNED \
  MAKE_SQLSTATE('3', '9', '0', '0', '1')
#define ERRCODE_E_R_I_E_NULL_VALUE_NOT_ALLOWED \
  MAKE_SQLSTATE('3', '9', '0', '0', '4')
#define ERRCODE_E_R_I_E_TRIGGER_PROTOCOL_VIOLATED \
  MAKE_SQLSTATE('3', '9', 'P', '0', '1')
#define ERRCODE_E_R_I_E_SRF_PROTOCOL_VIOLATED \
  MAKE_SQLSTATE('3', '9', 'P', '0', '2')
#define ERRCODE_E_R_I_E_EVENT_TRIGGER_PROTOCOL_VIOLATED \
  MAKE_SQLSTATE('3', '9', 'P', '0', '3')
...
#define ERRCODE_T_R_INTEGRITY_CONSTRAINT_VIOLATION \
  MAKE_SQLSTATE('4', '0', '0', '0', '2')
#define ERRCODE_T_R_SERIALIZATION_FAILURE MAKE_SQLSTATE('4', '0', '0', '0', '1')
#define ERRCODE_T_R_STATEMENT_COMPLETION_UNKNOWN \
  MAKE_SQLSTATE('4', '0', '0', '0', '3')
#define ERRCODE_T_R_DEADLOCK_DETECTED MAKE_SQLSTATE('4', '0', 'P', '0', '1')

/* Class 42 - Syntax Error or Access Rule Violation */
#define ERRCODE_SYNTAX_ERROR_OR_ACCESS_RULE_VIOLATION \
...
#define ERRCODE_INVALID_DATABASE_DEFINITION \
  MAKE_SQLSTATE('4', '2', 'P', '1', '2')
#define ERRCODE_INVALID_FUNCTION_DEFINITION \
  MAKE_SQLSTATE('4', '2', 'P', '1', '3')
#define ERRCODE_INVALID_PSTATEMENT_DEFINITION \
  MAKE_SQLSTATE('4', '2', 'P', '1', '4')
...
#define ERRCODE_WITH_CHECK_OPTION_VIOLATION \
  MAKE_SQLSTATE('4', '4', '0', '0', '0')
...
#define ERRCODE_CONFIGURATION_LIMIT_EXCEEDED \
  MAKE_SQLSTATE('5', '3', '4', '0', '0')
...
#define ERRCODE_OBJECT_NOT_IN_PREREQUISITE_STATE \
  MAKE_SQLSTATE('5', '5', '0', '0', '0')
...
#define ERRCODE_FDW_DYNAMIC_PARAMETER_VALUE_NEEDED \
  MAKE_SQLSTATE('H', 'V', '0', '0', '2')
#define ERRCODE_FDW_FUNCTION_SEQUENCE_ERROR \
  MAKE_SQLSTATE('H', 'V', '0', '1', '0')
#define ERRCODE_FDW_INCONSISTENT_DESCRIPTOR_INFORMATION \
  MAKE_SQLSTATE('H', 'V', '0', '2', '1')
#define ERRCODE_FDW_INVALID_ATTRIBUTE_VALUE \
  MAKE_SQLSTATE('H', 'V', '0', '2', '4')
...
#define ERRCODE_FDW_INVALID_DATA_TYPE_DESCRIPTORS \
  MAKE_SQLSTATE('H', 'V', '0', '0', '6')
#define ERRCODE_FDW_INVALID_DESCRIPTOR_FIELD_IDENTIFIER \
  MAKE_SQLSTATE('H', 'V', '0', '9', '1')
...
#define ERRCODE_FDW_INVALID_STRING_LENGTH_OR_BUFFER_LENGTH \
  MAKE_SQLSTATE('H', 'V', '0', '9', '0')
#define ERRCODE_FDW_INVALID_STRING_FORMAT MAKE_SQLSTATE('H', 'V', '0', '0', 'A')
#define ERRCODE_FDW_INVALID_USE_OF_NULL_POINTER \
  MAKE_SQLSTATE('H', 'V', '0', '0', '9')
...
#define ERRCODE_FDW_UNABLE_TO_CREATE_EXECUTION \
  MAKE_SQLSTATE('H', 'V', '0', '0', 'L')
#define ERRCODE_FDW_UNABLE_TO_CREATE_REPLY \
  MAKE_SQLSTATE('H', 'V', '0', '0', 'M')
#define ERRCODE_FDW_UNABLE_TO_ESTABLISH_CONNECTION \
  MAKE_SQLSTATE('H', 'V', '0', '0', 'N')
