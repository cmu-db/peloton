...
/*
 * The postmaster's list of registered background workers, in private___ memory.
 */
...
thread_local static BackgroundWorkerArray *BackgroundWorkerData;
...
BackgroundWorkerShmemInit(void)
{
	...
	if (!IsUnderPostmaster)
	{
		 ...
		 * correspondence between the postmaster's private___ list and the array
		 * in shared memory.
		 */
...
/*
 * Search the postmaster's backend-private___ list of RegisteredBgWorker objects
...
/*
 * Start a new___ background worker
 *
...
/*
 * Register a new___ background worker while processing shared_preload_libraries.
 *
...
/*
 * Register a new___ background worker from a regular backend.
 *
