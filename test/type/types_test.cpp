...
TEST_F(TypesTests, DatePartTypeTest) {
  std::vector<DatePartType> list = {DatePartType::INVALID,
                                    DatePartType::CENTURY,
                                    DatePartType::DAY,
                                    DatePartType::DAYS,
                                    DatePartType::DECADE,
                                    DatePartType::DECADES,
                                    DatePartType::DOW,
                                    DatePartType::DOY,
                                    DatePartType::EPOCH,
                                    DatePartType::HOUR,
                                    DatePartType::HOURS,
                                    DatePartType::ISODOW,
                                    DatePartType::ISOYEAR,
                                    DatePartType::MICROSECOND,
                                    DatePartType::MICROSECONDS,
                                    DatePartType::MILLENNIUM,
                                    DatePartType::MILLISECOND,
                                    DatePartType::MILLISECONDS,
                                    DatePartType::MINUTE,
                                    DatePartType::MINUTES,
                                    DatePartType::MONTH,
                                    DatePartType::MONTHS,
                                    DatePartType::QUARTER,
                                    DatePartType::QUARTERS,
                                    DatePartType::SECOND,
                                    DatePartType::SECONDS,
                                    DatePartType::TIMEZONE,
                                    DatePartType::TIMEZONE_HOUR,
                                    DatePartType::TIMEZONE_HOURS,
                                    DatePartType::TIMEZONE_MINUTE,
                                    DatePartType::TIMEZONE_MINUTES,
                                    DatePartType::WEEK,
                                    DatePartType::WEEKS,
                                    DatePartType::YEAR,
                                    DatePartType::YEARS};
