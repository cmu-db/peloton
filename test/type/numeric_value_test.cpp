...
void CheckCompare5(T x, T y, type::TypeId xtype) {
  type::Value v1 = type::Value(xtype, x);
  type::Value v2 =
      type::ValueFactory::GetVarcharValue(type::Value(xtype, y).ToString());
  if (x == y)
    CheckEqual(v1, v2);
  else if (x < y)
    CheckLessThan(v1, v2);
...
void CheckMath1(T1 x, T2 y, type::TypeId xtype, type::TypeId ytype) {
  ...
  // Test sqrt(x)
  if (x < 0) {
    EXPECT_THROW(type::Value(xtype, x).Sqrt(), peloton::Exception);
  } else {
...
void CheckMath2(T x, double y, type::TypeId xtype) {
  ...
  if (y == 0)
    EXPECT_THROW(
        type::Value(xtype, x).Divide(type::ValueFactory::GetDecimalValue(y)),
        peloton::Exception);
  else {
  ...
  if (y == 0)
    EXPECT_THROW(
        type::Value(xtype, x).Modulo(type::ValueFactory::GetDecimalValue(y)),
        peloton::Exception);
  else {
...
void CheckMath3(double x, T y, type::TypeId ytype) {
  ...
  if (y == 0)
    EXPECT_THROW(
        type::ValueFactory::GetDecimalValue(x).Divide(type::Value(ytype, y)),
        peloton::Exception);
  else {
  ...
  if (y == 0)
    EXPECT_THROW(
        type::ValueFactory::GetDecimalValue(x).Modulo(type::Value(ytype, y)),
        peloton::Exception);
  else {
...
void CheckMath4(double x, double y) {
  ...
  v1 = type::ValueFactory::GetDecimalValue(x)
           .Add(type::ValueFactory::GetDecimalValue(y));
  v2 = type::ValueFactory::GetDecimalValue(x + y);
  CheckEqual(v1, v2);

  v1 = type::ValueFactory::GetDecimalValue(x)
           .Subtract(type::ValueFactory::GetDecimalValue(y));
  v2 = type::ValueFactory::GetDecimalValue(x - y);
  CheckEqual(v1, v2);

  v1 = type::ValueFactory::GetDecimalValue(x)
           .Multiply(type::ValueFactory::GetDecimalValue(y));
  v2 = type::ValueFactory::GetDecimalValue(x * y);
  CheckEqual(v1, v2);

  // Divide by zero detection
  if (y == 0)
    EXPECT_THROW(type::ValueFactory::GetDecimalValue(x)
                     .Divide(type::ValueFactory::GetDecimalValue(y)),
                 peloton::Exception);
  else {
    v1 = type::ValueFactory::GetDecimalValue(x)
             .Divide(type::ValueFactory::GetDecimalValue(y));
  ...
  if (y == 0)
    EXPECT_THROW(type::ValueFactory::GetDecimalValue(x)
                     .Modulo(type::ValueFactory::GetDecimalValue(y)),
                 peloton::Exception);
  else {
    v1 = type::ValueFactory::GetDecimalValue(x)
             .Modulo(type::ValueFactory::GetDecimalValue(y));
...
TEST_F(NumericValueTests, TinyIntComparisonTest) {
  ...
  for (int i = 0; i < TEST_NUM; i++) {
    CheckCompare1<int8_t, int8_t>(RANDOM8(), RANDOM8(), type::TypeId::TINYINT,
                                  type::TypeId::TINYINT);
    CheckCompare1<int8_t, int16_t>(RANDOM8(), RANDOM16(), type::TypeId::TINYINT,
                                   type::TypeId::SMALLINT);
    CheckCompare1<int8_t, int32_t>(RANDOM8(), RANDOM32(), type::TypeId::TINYINT,
                                   type::TypeId::INTEGER);
    CheckCompare1<int8_t, int64_t>(RANDOM8(), RANDOM64(), type::TypeId::TINYINT,
                                   type::TypeId::BIGINT);
...
TEST_F(NumericValueTests, SmallIntComparisonTest) {
  std::srand(SEED);
  for (int i = 0; i < TEST_NUM; i++) {
    CheckCompare1<int16_t, int8_t>(
        RANDOM16(), RANDOM8(), type::TypeId::SMALLINT, type::TypeId::TINYINT);
    CheckCompare1<int16_t, int16_t>(
        RANDOM16(), RANDOM16(), type::TypeId::SMALLINT, type::TypeId::SMALLINT);
    CheckCompare1<int16_t, int32_t>(
        RANDOM16(), RANDOM32(), type::TypeId::SMALLINT, type::TypeId::INTEGER);
    CheckCompare1<int16_t, int64_t>(
        RANDOM16(), RANDOM64(), type::TypeId::SMALLINT, type::TypeId::BIGINT);
...
TEST_F(NumericValueTests, IntComparisonTest) {
  std::srand(SEED);
  for (int i = 0; i < TEST_NUM; i++) {
    CheckCompare1<int32_t, int8_t>(RANDOM32(), RANDOM8(), type::TypeId::INTEGER,
                                   type::TypeId::TINYINT);
    CheckCompare1<int32_t, int16_t>(
        RANDOM32(), RANDOM16(), type::TypeId::INTEGER, type::TypeId::SMALLINT);
    CheckCompare1<int32_t, int32_t>(
        RANDOM32(), RANDOM32(), type::TypeId::INTEGER, type::TypeId::INTEGER);
    CheckCompare1<int32_t, int64_t>(
        RANDOM32(), RANDOM64(), type::TypeId::INTEGER, type::TypeId::BIGINT);
...
TEST_F(NumericValueTests, BigIntComparisonTest) {
  std::srand(SEED);
  for (int i = 0; i < TEST_NUM; i++) {
    CheckCompare1<int64_t, int8_t>(RANDOM64(), RANDOM8(), type::TypeId::BIGINT,
                                   type::TypeId::TINYINT);
    CheckCompare1<int64_t, int16_t>(
        RANDOM64(), RANDOM16(), type::TypeId::BIGINT, type::TypeId::SMALLINT);
    CheckCompare1<int64_t, int32_t>(
        RANDOM64(), RANDOM32(), type::TypeId::BIGINT, type::TypeId::INTEGER);
    CheckCompare1<int64_t, int64_t>(RANDOM64(), RANDOM64(),
                                    type::TypeId::BIGINT, type::TypeId::BIGINT);
...
TEST_F(NumericValueTests, MathTest) {
  ...
  for (int i = 0; i < TEST_NUM; i++) {
    CheckMath1<int8_t, int8_t>(RANDOM8(), RANDOM8(), type::TypeId::TINYINT,
                               type::TypeId::TINYINT);
    CheckMath1<int8_t, int16_t>(RANDOM8(), RANDOM16(), type::TypeId::TINYINT,
                                type::TypeId::SMALLINT);
    CheckMath1<int8_t, int32_t>(RANDOM8(), RANDOM32(), type::TypeId::TINYINT,
                                type::TypeId::INTEGER);
    CheckMath1<int8_t, int64_t>(RANDOM8(), RANDOM64(), type::TypeId::TINYINT,
                                type::TypeId::BIGINT);
    CheckMath2<int8_t>(RANDOM8(), RANDOM_DECIMAL(), type::TypeId::TINYINT);

    CheckMath1<int16_t, int8_t>(RANDOM16(), RANDOM8(), type::TypeId::SMALLINT,
                                type::TypeId::TINYINT);
    CheckMath1<int16_t, int16_t>(RANDOM16(), RANDOM16(), type::TypeId::SMALLINT,
                                 type::TypeId::SMALLINT);
    CheckMath1<int16_t, int32_t>(RANDOM16(), RANDOM32(), type::TypeId::SMALLINT,
                                 type::TypeId::INTEGER);
    CheckMath1<int16_t, int64_t>(RANDOM16(), RANDOM64(), type::TypeId::SMALLINT,
                                 type::TypeId::BIGINT);
    CheckMath2<int16_t>(RANDOM16(), RANDOM_DECIMAL(), type::TypeId::SMALLINT);

    CheckMath1<int32_t, int8_t>(RANDOM32(), RANDOM8(), type::TypeId::INTEGER,
                                type::TypeId::TINYINT);
    CheckMath1<int32_t, int16_t>(RANDOM32(), RANDOM16(), type::TypeId::INTEGER,
                                 type::TypeId::SMALLINT);
    CheckMath1<int32_t, int32_t>(RANDOM32(), RANDOM32(), type::TypeId::INTEGER,
                                 type::TypeId::INTEGER);
    CheckMath1<int32_t, int64_t>(RANDOM32(), RANDOM64(), type::TypeId::BIGINT,
                                 type::TypeId::BIGINT);
    CheckMath2<int32_t>(RANDOM32(), RANDOM_DECIMAL(), type::TypeId::INTEGER);

    CheckMath1<int64_t, int8_t>(RANDOM64(), RANDOM8(), type::TypeId::BIGINT,
                                type::TypeId::TINYINT);
    CheckMath1<int64_t, int16_t>(RANDOM64(), RANDOM16(), type::TypeId::BIGINT,
                                 type::TypeId::SMALLINT);
    CheckMath1<int64_t, int32_t>(RANDOM64(), RANDOM32(), type::TypeId::BIGINT,
                                 type::TypeId::INTEGER);
    CheckMath1<int64_t, int64_t>(RANDOM64(), RANDOM64(), type::TypeId::BIGINT,
                                 type::TypeId::BIGINT);
...
TEST_F(NumericValueTests, CastAsTest) {
  std::vector<type::TypeId> types = {
      ...
      type::TypeId::BIGINT,  type::TypeId::DECIMAL,  type::TypeId::VARCHAR,
  };
  ...
  for (int i = type::PELOTON_INT8_MIN; i <= type::PELOTON_INT8_MAX; i++) {
    for (auto t1 : types) {
      ...
      for (auto t2 : types) {
        ...
        LOG_TRACE("[%02d] %s -> %s", i, TypeIdToString(t1).c_str(),
...
TEST_F(NumericValueTests, DivideByZeroTest) {
  ...
  CheckMath1<int8_t, int8_t>(RANDOM8(), 0, type::TypeId::TINYINT,
                             type::TypeId::TINYINT);
  CheckMath1<int8_t, int16_t>(RANDOM8(), 0, type::TypeId::TINYINT,
                              type::TypeId::SMALLINT);
  CheckMath1<int8_t, int32_t>(RANDOM8(), 0, type::TypeId::TINYINT,
                              type::TypeId::INTEGER);
  CheckMath1<int8_t, int64_t>(RANDOM8(), 0, type::TypeId::TINYINT,
                              type::TypeId::BIGINT);
  CheckMath2<int8_t>(RANDOM8(), 0, type::TypeId::TINYINT);

  CheckMath1<int16_t, int8_t>(RANDOM16(), 0, type::TypeId::SMALLINT,
                              type::TypeId::TINYINT);
  CheckMath1<int16_t, int16_t>(RANDOM16(), 0, type::TypeId::SMALLINT,
                               type::TypeId::SMALLINT);
  CheckMath1<int16_t, int32_t>(RANDOM16(), 0, type::TypeId::SMALLINT,
                               type::TypeId::INTEGER);
  CheckMath1<int16_t, int64_t>(RANDOM16(), 0, type::TypeId::SMALLINT,
                               type::TypeId::BIGINT);
  CheckMath2<int16_t>(RANDOM16(), 0, type::TypeId::SMALLINT);

  CheckMath1<int32_t, int8_t>(RANDOM32(), 0, type::TypeId::INTEGER,
                              type::TypeId::TINYINT);
  CheckMath1<int32_t, int16_t>(RANDOM32(), 0, type::TypeId::INTEGER,
                               type::TypeId::SMALLINT);
  CheckMath1<int32_t, int32_t>(RANDOM32(), 0, type::TypeId::INTEGER,
                               type::TypeId::INTEGER);
  CheckMath1<int32_t, int64_t>(RANDOM32(), 0, type::TypeId::BIGINT,
                               type::TypeId::BIGINT);
  CheckMath2<int32_t>(RANDOM32(), 0, type::TypeId::INTEGER);

  CheckMath1<int64_t, int8_t>(RANDOM64(), 0, type::TypeId::BIGINT,
                              type::TypeId::TINYINT);
  CheckMath1<int64_t, int16_t>(RANDOM64(), 0, type::TypeId::BIGINT,
                               type::TypeId::SMALLINT);
  CheckMath1<int64_t, int32_t>(RANDOM64(), 0, type::TypeId::BIGINT,
                               type::TypeId::INTEGER);
  CheckMath1<int64_t, int64_t>(RANDOM64(), 0, type::TypeId::BIGINT,
                               type::TypeId::BIGINT);
...
TEST_F(NumericValueTests, NullValueTest) {
  ...
  bool_result[0] =
      type::ValueFactory::GetTinyIntValue((int8_t)type::PELOTON_INT8_NULL)
          .CompareEquals(type::ValueFactory::GetIntegerValue(rand()));
  bool_result[1] =
      type::ValueFactory::GetSmallIntValue((int16_t)type::PELOTON_INT16_NULL)
          .CompareEquals(type::ValueFactory::GetIntegerValue(rand()));
  bool_result[2] =
  ...
  result[0] =
      type::ValueFactory::GetTinyIntValue((int8_t)type::PELOTON_INT8_NULL)
          .Add(type::ValueFactory::GetIntegerValue(rand()));
  result[1] =
      type::ValueFactory::GetSmallIntValue((int16_t)type::PELOTON_INT16_NULL)
          .Add(type::ValueFactory::GetIntegerValue(rand()));
  result[2] =
  ...
  result[0] =
      type::ValueFactory::GetTinyIntValue((int8_t)type::PELOTON_INT8_NULL)
          .Subtract(type::ValueFactory::GetIntegerValue(rand()));
  result[1] =
      type::ValueFactory::GetSmallIntValue((int16_t)type::PELOTON_INT16_NULL)
          .Subtract(type::ValueFactory::GetIntegerValue(rand()));
  result[2] =
  ...
  result[0] =
      type::ValueFactory::GetTinyIntValue((int8_t)type::PELOTON_INT8_NULL)
          .Multiply(type::ValueFactory::GetIntegerValue(rand()));
  result[1] =
      type::ValueFactory::GetSmallIntValue((int16_t)type::PELOTON_INT16_NULL)
          .Multiply(type::ValueFactory::GetIntegerValue(rand()));
  result[2] =
  ...
  result[0] =
      type::ValueFactory::GetTinyIntValue((int8_t)type::PELOTON_INT8_NULL)
          .Divide(type::ValueFactory::GetIntegerValue(rand()));
  result[1] =
      type::ValueFactory::GetSmallIntValue((int16_t)type::PELOTON_INT16_NULL)
          .Divide(type::ValueFactory::GetIntegerValue(rand()));
  result[2] =
  ...
  result[0] =
      type::ValueFactory::GetTinyIntValue((int8_t)type::PELOTON_INT8_NULL)
          .Modulo(type::ValueFactory::GetIntegerValue(rand()));
  result[1] =
      type::ValueFactory::GetSmallIntValue((int16_t)type::PELOTON_INT16_NULL)
          .Modulo(type::ValueFactory::GetIntegerValue(rand()));
  result[2] =
