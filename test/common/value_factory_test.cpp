...
TEST_F(ValueFactoryTests, CastTest) {
  ...
  std::unique_ptr<common::Value> cmp3(v3->CompareEquals(*v4));
  EXPECT_TRUE(cmp3->IsTrue());

  std::unique_ptr<common::Value> v5(common::ValueFactory::CastAsVarchar(common::Value(common::Type::TINYINT, (int8_t)common::PELOTON_INT8_MAX)));
  EXPECT_EQ(v5->ToString(), "127");
  std::unique_ptr<common::Value> v6(common::ValueFactory::CastAsVarchar(common::Value(common::Type::BIGINT, (int64_t)common::PELOTON_INT64_MAX)));
  EXPECT_EQ(v6->ToString(), "9223372036854775807");

  std::string str1("9999-12-31 23:59:59.999999+14");
  std::unique_ptr<common::Value> v7(common::ValueFactory::CastAsTimestamp(common::Value(common::Type::VARCHAR, str1)));
  EXPECT_EQ(v7->ToString(), str1);
  std::string str2("9999-12-31 23:59:59-01");
  std::unique_ptr<common::Value> v77(common::ValueFactory::CastAsTimestamp(common::Value(common::Type::VARCHAR, str2)));
  ...
  std::unique_ptr<common::Value> v8(common::ValueFactory::CastAsBigInt(common::Value(common::Type::VARCHAR, "9223372036854775807")));
  ...
  std::unique_ptr<common::Value> v9(common::ValueFactory::CastAsInteger(common::Value(common::Type::VARCHAR, "2147483647")));
  ...
  std::unique_ptr<common::Value> v10(common::ValueFactory::CastAsSmallInt(common::Value(common::Type::VARCHAR, "32767")));
  ...
  std::unique_ptr<common::Value> v11(common::ValueFactory::CastAsTinyInt(common::Value(common::Type::VARCHAR, "127")));
