...
TEST_F(WhatIfIndexTests, SingleColTest) {
  ...
  TestingIndexSelectionUtil testing_util(db_name);
  ...
  LOG_TRACE("Cost of the query without indexes: %lf", cost_without_index);
  EXPECT_NE(result->plan, nullptr);
  LOG_TRACE("%s", result->plan->GetInfo().c_str());
  ...
  LOG_TRACE("Cost of the query with 1 index: %lf", cost_with_index_1);
  EXPECT_NE(result->plan, nullptr);
  LOG_TRACE("%s", result->plan->GetInfo().c_str());
  ...
  EXPECT_EQ(result->plan->GetPlanNodeType(), PlanNodeType::INDEXSCAN);
  LOG_TRACE("Cost of the query with 2 indexes: %lf", cost_with_index_2);
...
TEST_F(WhatIfIndexTests, MultiColumnTest1) {
  ...
  result = brain::WhatIfIndex::GetCostAndBestPlanTree(sql_statement, config,
                                                      DEFAULT_DB_NAME, txn);
  auto cost_with_index_2 = result->cost;
  LOG_TRACE("Cost of the query with index {'a', 'b'}: %lf", cost_with_index_2);
  EXPECT_EQ(result->plan->GetPlanNodeType(), PlanNodeType::SEQSCAN);
  ...
  LOG_TRACE("Cost of the query with index {'b', 'c'}: %lf", cost_with_index_3);
  EXPECT_EQ(result->plan->GetPlanNodeType(), PlanNodeType::INDEXSCAN);
  ...
  EXPECT_EQ(result->plan->GetPlanNodeType(), PlanNodeType::INDEXSCAN);
  LOG_TRACE("Cost of the query with index {'b'}: %lf", cost_with_index_4);
  LOG_TRACE("%s", result->plan->GetInfo().c_str());
...
TEST_F(WhatIfIndexTests, MultiColumnTest2) {
  ...
  auto cost_with_index_1 = result->cost;
  EXPECT_EQ(result->plan->GetPlanNodeType(), PlanNodeType::SEQSCAN);
  LOG_TRACE("Cost of the query with index {'a', 'b', 'c', 'd', 'e'}: %lf",
            cost_with_index_1);
  EXPECT_DOUBLE_EQ(cost_without_index, cost_with_index_1);
  ...
  auto cost_with_index_2 = result->cost;
  EXPECT_EQ(result->plan->GetPlanNodeType(), PlanNodeType::SEQSCAN);
  LOG_TRACE("Cost of the query with index {'a', 'c', 'd', 'f'}: %lf",
            cost_with_index_2);
  EXPECT_DOUBLE_EQ(cost_without_index, cost_with_index_2);
  ...
  auto cost_with_index_3 = result->cost;
  EXPECT_EQ(result->plan->GetPlanNodeType(), PlanNodeType::SEQSCAN);
  LOG_TRACE("Cost of the query with index {'a', 'b', 'd', 'e'}: %lf",
            cost_with_index_3);
  ...
  auto cost_with_index_4 = result->cost;
  EXPECT_EQ(result->plan->GetPlanNodeType(), PlanNodeType::INDEXSCAN);
  LOG_TRACE("Cost of the query with index {'b', 'c', 'e'}: %lf",
            cost_with_index_4);
  ...
  EXPECT_EQ(result->plan->GetPlanNodeType(), PlanNodeType::INDEXSCAN);
  LOG_TRACE("Cost of the query with index {'b', 'c', 'd', 'e'}: %lf",
            cost_with_index_5);
  ...
  EXPECT_EQ(result->plan->GetPlanNodeType(), PlanNodeType::INDEXSCAN);
  LOG_TRACE("Cost of the query with index {'b', 'e'}: %lf", cost_with_index_6);
  ...
  EXPECT_EQ(result->plan->GetPlanNodeType(), PlanNodeType::INDEXSCAN);
  LOG_TRACE("Cost of the query with index {'e'} : %lf", cost_with_index_7);
  ...
  LOG_TRACE("Cost of the query with index {'b'}: %lf", cost_with_index_8);
  EXPECT_EQ(result->plan->GetPlanNodeType(), PlanNodeType::INDEXSCAN);
...
TEST_F(WhatIfIndexTests, MultiColumnTest3) {
  ...
  LOG_TRACE("Query1: %s", query1.c_str());
  LOG_TRACE("Query2: %s", query2.c_str());
  LOG_TRACE("Query3: %s", query3.c_str());
  ...
  LOG_TRACE("Cost of the query without indexes {}: %lf", cost_without_index);
  LOG_TRACE("%s", result1->plan->GetInfo().c_str());
  ...
  LOG_TRACE("Cost of the query with index {'a'}: %lf", cost_with_index_1_1);
  EXPECT_EQ(result1->plan->GetPlanNodeType(), PlanNodeType::INDEXSCAN);
  EXPECT_GT(cost_without_index, cost_with_index_1_1);
  EXPECT_DOUBLE_EQ(cost_with_index_1_1, cost_with_index_1_2);
  EXPECT_DOUBLE_EQ(cost_with_index_1_2, cost_with_index_1_3);
  ...
  EXPECT_EQ(result1->plan->GetPlanNodeType(), PlanNodeType::INDEXSCAN);
  LOG_TRACE("Cost of the query with index {'a', 'b'}: %lf",
            cost_with_index_2_1);
  ...
  EXPECT_DOUBLE_EQ(cost_with_index_2_2, cost_with_index_2_3);
  ...
  EXPECT_EQ(result1->plan->GetPlanNodeType(), PlanNodeType::INDEXSCAN);
  LOG_TRACE("Cost of the query with index {'a', 'b', 'c'}: %lf",
            cost_with_index_3_1);
  ...
  EXPECT_DOUBLE_EQ(cost_with_index_3_2, cost_with_index_3_3);
  ...
  EXPECT_EQ(result1->plan->GetPlanNodeType(), PlanNodeType::INDEXSCAN);
  LOG_TRACE("Cost of the query with index {'a', 'b', 'c', 'd'}: %lf",
            cost_with_index_4_1);
  EXPECT_GT(cost_without_index, cost_with_index_4_1);
  EXPECT_GT(cost_with_index_3_1, cost_with_index_4_1);
  // TODO(saatviks): Changed from DOUBLE to FLOAT_EQ
  EXPECT_FLOAT_EQ(cost_with_index_4_1, cost_with_index_4_2);
  EXPECT_FLOAT_EQ(cost_with_index_4_2, cost_with_index_4_3);
