...
storage::DataTable *TransactionTestsUtil::CreateCombinedPrimaryKeyTable() {
  ...
  auto index_metadata =
      new index::IndexMetadata("primary_btree_index", 1234, INDEX_TYPE_BWTREE,
...
storage::DataTable *TransactionTestsUtil::CreatePrimaryKeyUniqueKeyTable() {
  ...
  auto index_metadata2 =
      new index::IndexMetadata("unique_btree_index", 1235, INDEX_TYPE_BWTREE,
...
storage::DataTable *TransactionTestsUtil::CreateTable(
  ...
  auto index_metadata = new index::IndexMetadata(
      "primary_btree_index", index_oid, INDEX_TYPE_BWTREE,
