...
//      scheduler.Run();
//      EXPECT_EQ(RESULT_TYPE_SUCCESS, scheduler.schedules[0].txn_result);
//      EXPECT_EQ(RESULT_TYPE_ABORTED, scheduler.schedules[1].txn_result);
//      EXPECT_EQ(RESULT_TYPE_ABORTED, scheduler.schedules[2].txn_result);
//
...
//      EXPECT_EQ(RESULT_TYPE_ABORTED, scheduler.schedules[0].txn_result);
//      EXPECT_EQ(RESULT_TYPE_SUCCESS, scheduler.schedules[1].txn_result);
//      EXPECT_EQ(RESULT_TYPE_SUCCESS, scheduler.schedules[2].txn_result);
//
