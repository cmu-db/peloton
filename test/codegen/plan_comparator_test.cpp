...
public:
  ...
  std::unique_ptr<planner::SeqScanPlan> GetSeqScanPlan() {
    //
    ...
    return std::unique_ptr<planner::SeqScanPlan>(new planner::SeqScanPlan(&GetTestTable(TestTableId()), a_gt_40, {0, 1}));
  }

  std::unique_ptr<planner::SeqScanPlan> GetSeqScanPlanWithPlan() {
    //
    ...
    return std::unique_ptr<planner::SeqScanPlan>(new planner::SeqScanPlan(&GetTestTable(TestTableId()), conj_eq, {0, 1, 2}));
  }

  std::unique_ptr<planner::HashJoinPlan> GetHashJoinPlan() {
    //
    // SELECT
    ...
    return std::move(hj_plan);
  }

  std::unique_ptr<planner::AggregatePlan> GetAggregatePlan() {
    //
...
TEST_F(PlanComparatorTest, SimpleCacheCheck) {
  ...
  std::unique_ptr<planner::SeqScanPlan> scan = std::move(GetSeqScanPlan());
  std::unique_ptr<planner::SeqScanPlan> scan2 = std::move(GetSeqScanPlan());
  // Do binding
  ...
  // COMPILE and execute
  CompileAndExecuteWithCache(std::move(scan), buffer, reinterpret_cast<char*>(buffer.GetState()));
  ...
  CompileAndExecuteWithCache(std::move(scan2), buffer2, reinterpret_cast<char*>(buffer2.GetState()));
...
TEST_F(PlanComparatorTest, SeqScanCacheCheck) {
  ...
  // SELECT a, b, c FROM table where a >= 20 and b = 21;
  //
  std::unique_ptr<planner::SeqScanPlan> scan = std::move(GetSeqScanPlanWithPlan());
  std::unique_ptr<planner::SeqScanPlan> scan2 = std::move(GetSeqScanPlanWithPlan());
  // Do binding
  planner::BindingContext context;
  scan->PerformBinding(context);
  planner::BindingContext context2;
...
TEST_F(PlanComparatorTest, HashJoinPlanCacheCheck) {
  ...
  std::unique_ptr<planner::HashJoinPlan> hj_plan = std::move(GetHashJoinPlan());
  std::unique_ptr<planner::AbstractPlan> hj_plan2 = std::move(GetHashJoinPlan());
  ...
  // COMPILE and run
  CompileAndExecuteWithCache(std::move(hj_plan), buffer,
 ...
 // Check results
  ...
  // COMPILE and run
  CompileAndExecuteWithCache(std::move(hj_plan2), buffer2,
...
TEST_F(PlanComparatorTest, OrderByCacheCheck) {
  ...
  std::unique_ptr<planner::OrderByPlan> order_by_plan_2{
      new planner::OrderByPlan({1, 0}, {true, false}, {0, 1, 2, 3})};
  std::unique_ptr<planner::OrderByPlan> order_by_plan_3{
  ...
  CompileAndExecuteWithCache(std::move(order_by_plan), buffer,
                    reinterpret_cast<char *>(buffer.GetState()));
  ...
  CompileAndExecuteWithCache(std::move(order_by_plan_2), buffer2,
                    reinterpret_cast<char *>(buffer2.GetState()));
...
TEST_F(PlanComparatorTest, AggregatePlanCacheCheck) {
  ...
  std::unique_ptr<planner::AggregatePlan> agg_plan = std::move(GetAggregatePlan());
  std::unique_ptr<planner::AggregatePlan> agg_plan2 = std::move(GetAggregatePlan());
  planner::BindingContext context, context2;
  ...
  // Compile it all
  CompileAndExecuteWithCache(std::move(agg_plan), buffer,
                    reinterpret_cast<char*>(buffer.GetState()));
  ...
  CompileAndExecuteWithCache(std::move(agg_plan2), buffer2,
                    reinterpret_cast<char*>(buffer2.GetState()));
