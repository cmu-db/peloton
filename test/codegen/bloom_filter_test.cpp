...
//  // define @TestBloomFilter(BloomFilter* bloom_filter, i32* numbers, i32
//  size,
...
//    llvm::Value *half_size = codegen->CreateUDiv(size_val,
//    codegen.Const32(2));
...
//          codegen->CreateInBoundsGEP(codegen.Int32Type(), number_array,
//          index));
...
TEST_F(BloomFilterCodegenTest, PerformanceTest) {
  ...
  int L3_cache_size = 15360000;
//    int L3_cache_size = 6291456;
  //  const int L3_cache_size = 600000;
  const int table1_target_size = L3_cache_size * 40;
