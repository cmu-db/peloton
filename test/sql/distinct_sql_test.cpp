...
TEST_F(DistinctSQLTests, DistinctDateTimeTest) {
  ...
  EXPECT_EQ(0, rows_changed);
  EXPECT_EQ(2, result.size() / tuple_descriptor.size());
  EXPECT_EQ("2016-06-22 19:10:25.000000-07", TestingSQLUtil::GetResultValueAsString(result, 0));
  EXPECT_EQ("2017-06-22 19:10:25.000000-07", TestingSQLUtil::GetResultValueAsString(result, 1));
