...
class TestingArtUtil {
 public:
  ...
  //
  //  static void NonUniqueKeyMultiThreadedStressTest2(const IndexType
  //  index_type);
  ...
  static void InsertHelper(storage::DataTable *table,
                           ...
                           size_t scale_factor, int num_rows, bool random,
  ...
  static void DeleteHelperMicroBench(index::ArtIndex *index, int num_rows,
                                     UNUSED_ATTRIBUTE uint64_t thread_itr);

  static void ScanHelperMicroBench(index::ArtIndex *index, size_t scale_factor,
                                   int total_rows, int insert_workers,
                                   UNUSED_ATTRIBUTE uint64_t thread_itr);
