...
TEST_F(ConfigurationManagerTests, InitializationTest) {
  ...
  std::string socket_family = GET_STRING("socket_family");
  ...
  txn = txn_manager.BeginTransaction();
  bool index_tuner = GET_BOOL("index_tuner");
...
TEST_F(ConfigurationManagerTests, ModificationTest) {
  ...
  auto txn = txn_manager.BeginTransaction();
  uint64_t value1 = GET_INT("test_int");
  ...
  SET_INT("test_int", 1234);

  txn = txn_manager.BeginTransaction();
  uint64_t value3 = GET_INT("test_int");
  ...
  txn = txn_manager.BeginTransaction();
  bool value5 = GET_BOOL("test_bool");
  ...
  SET_BOOL("test_bool", false);

  txn = txn_manager.BeginTransaction();
  bool value7 = GET_BOOL("test_bool");
  ...
  txn = txn_manager.BeginTransaction();
  std::string value9 = GET_STRING("test_string");
  ...
  SET_STRING("test_string", "qwer");

  txn = txn_manager.BeginTransaction();
  std::string value11 = GET_STRING("test_string");
