...
if(PROTOBUF_FOUND)
  ...
  peloton_parse_header(${PROTOBUF_INCLUDE_DIR}/google/protobuf/stubs/common.h VERION_LINE GOOGLE_PROTOBUF_VERSION)
...
set(proto_gen_folder "${PROJECT_BINARY_DIR}/include/peloton/proto")
...
function(peloton_protobuf_generate_cpp_py output_dir srcs_var hdrs_var python_var)
  if(NOT ARGN)
    message(SEND_ERROR "Error: peloton_protobuf_generate_cpp_py() called without any proto files")
    return()
  endif()
