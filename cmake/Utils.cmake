...
function(peloton_string_unique __string)
  if(${__string})
    set(__list ${${__string}})
...
function(peloton_merge_flag_lists out_var)
  set(__result "")
  foreach(__list ${ARGN})
...
function(peloton_convert_absolute_paths variable)
  set(__dlist "")
...
macro(peloton_parse_header FILENAME FILE_VAR)
  set(vars_regex "")
...
function(peloton_parse_header_single_define LIBNAME HDR_PATH VARNAME)
  set(${LIBNAME}_H "")
  if(EXISTS "${HDR_PATH}")
...
function(peloton_option variable description value)
  set(__value ${value})
  set(__condition "")
...
function(peloton_compare_lists list1 list2 desc)
  set(__list1 ${${list1}})
  set(__list2 ${${list2}})
  list(SORT __list1)
  list(SORT __list2)
...
macro(peloton_warnings_disable)
  set(_flag_vars "")
  set(_msvc_warnings "")
  set(_gxx_warnings "")
  ...
  peloton_clear_vars(_flag_vars _msvc_warnings _gxx_warnings)
endmacro()
...
function(peloton_get_current_definitions definitions_var)
...
function(peloton_parse_linker_libs Peloton_LINKER_LIBS_variable folders_var flags_var frameworks_var)
  ...
  foreach(list_elem ${${Peloton_LINKER_LIBS_variable}})
  ...
  peloton_list_unique(libflags folders)
...
function(peloton_detect_darwin_version output_var)
  if(APPLE)
