...
function(peloton_pickup_peloton_sources root)
  ...
  peloton_source_group("Include"        GLOB "${root}/include/peloton/*.h*")
  peloton_source_group("Include\\Util"  GLOB "${root}/include/peloton/util/*.h*")
  peloton_source_group("Include"        GLOB "${PROJECT_BINARY_DIR}/peloton_config.h*")
  peloton_source_group("Source"         GLOB "${root}/src/peloton/*.cpp")
  peloton_source_group("Source\\Util"   GLOB "${root}/src/peloton/util/*.cpp")
  peloton_source_group("Source\\Layers" GLOB "${root}/src/peloton/layers/*.cpp")
  peloton_source_group("Source\\Cuda"   GLOB "${root}/src/peloton/layers/*.cu")
  peloton_source_group("Source\\Cuda"   GLOB "${root}/src/peloton/util/*.cu")
  peloton_source_group("Source\\Proto"  GLOB "${root}/src/peloton/proto/*.proto")

  # source groups for test target
  peloton_source_group("Include"      GLOB "${root}/include/peloton/test/test_*.h*")
  peloton_source_group("Source"       GLOB "${root}/src/peloton/test/test_*.cpp")
  peloton_source_group("Source\\Cuda" GLOB "${root}/src/peloton/test/test_*.cu")

  # collect files
  file(GLOB test_hdrs    ${root}/include/peloton/test/test_*.h*)
  file(GLOB test_srcs    ${root}/src/peloton/test/test_*.cpp)
  file(GLOB_RECURSE hdrs ${root}/include/peloton/*.h*)
  file(GLOB_RECURSE srcs ${root}/src/peloton/*.cpp)
