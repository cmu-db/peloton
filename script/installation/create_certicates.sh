...
# remove other files
cp $DATA_DIR/intermediate/private/server.key.pem $DATA_DIR/server.key
cp $DATA_DIR/intermediate/private/client.key.pem $DATA_DIR/client.key
cp $DATA_DIR/intermediate/certs/ca-chain.cert.pem $DATA_DIR/root.crt
cp $DATA_DIR/intermediate/certs/server.cert.pem $DATA_DIR/server.crt
cp $DATA_DIR/intermediate/certs/client.cert.pem $DATA_DIR/client.crt
cd $DATA_DIR
shopt -s extglob
rm -rf !(intermediate_openssl.cnf|openssl.cnf|server.key|client.key|root.crt|server.crt|client.crt)
