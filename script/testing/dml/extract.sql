...
SELECT EXTRACT(EPOCH FROM val) AS epoch FROM foo ORDER BY val;
SELECT EXTRACT(HOUR FROM val) AS hour FROM foo ORDER BY val;
SELECT EXTRACT(ISODOW FROM val) AS isodow FROM foo ORDER BY val;
SELECT EXTRACT(ISOYEAR FROM val) AS isoyear FROM foo ORDER BY val;
...
SELECT COUNT(*) FROM foo WHERE EXTRACT(YEAR FROM val) = 2018;