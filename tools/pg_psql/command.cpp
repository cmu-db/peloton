			 ...
			 PQExpBuffer query_buf)
{
	 ...
	 * ctemplate if no argument is given
	 */
	...
	else if (strcmp(cmd, "password") == 0)
	{
		...
		pw1 = simple_prompt("Enter new___ password: ", 100, false);
...
#define PARAMS_ARRAY_SIZE	8
	...
	/*
	 * Replace the old connection with the new___ one, and update
	...
	/* Tell the user about the new___ connection */
	if (!pset.quiet)
	{
 ...
 * establishing a new___ connection.
 */
void
SyncVariables(void)
{
					   ...
					   unicode_linestyle *linestyle)
{
	...
	/* input is ok, generate new___ unicode style */
